...
void main() {
	...
	`}function gp(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===ra||l===aa,u=l===Jn||l===Ri;if(c||u){let h=e.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new sl(i)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const p=o.image;return c&&p&&p.height>0||u&&p&&s(p)?(t===null&&(t=new sl(i)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",r),h.texture):null}}}return o}function s(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function _p(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Ji("WebGLRenderer: "+n+" extension not supported."),s}}}function xp(i,e,t,n){const s={},r=new WeakMap;function a(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const _ in f.attributes)e.remove(f.attributes[_]);f.removeEventListener("dispose",a),delete s[f.id];const p=r.get(f);p&&(e.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const p in f)e.update(f[p],i.ARRAY_BUFFER)}function c(h){const f=[],p=h.index,_=h.attributes.position;let x=0;if(p!==null){const b=p.array;x=p.version;for(let S=0,E=b.length;S<E;S+=3){const A=b[S+0],w=b[S+1],C=b[S+2];f.push(A,w,w,C,C,A)}}else if(_!==void 0){const b=_.array;x=_.version;for(let S=0,E=b.length/3-1;S<E;S+=3){const A=S+0,w=S+1,C=S+2;f.push(A,w,w,C,C,A)}}else return;const m=new(Sc(f)?Ac:Tc)(f,1);m.version=x;const d=r.get(h);d&&e.remove(d),r.set(h,m)}function u(h){const f=r.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&c(h)}else c(h);return r.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function vp(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,p){i.drawElements(n,p,r,f*a),t.update(p,n,1)}function c(f,p,_){_!==0&&(i.drawElementsInstanced(n,p,r,f*a,_),t.update(p,n,_))}function u(f,p,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,_);let m=0;for(let d=0;d<_;d++)m+=p[d];t.update(m,n,1)}function h(f,p,_,x){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/a,p[d],x[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,x,0,_);let d=0;for(let b=0;b<_;b++)d+=p[b]*x[b];t.update(d,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Mp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:qe("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Sp(i,e,t){const n=new WeakMap,s=new dt;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==h){let y=function(){F.dispose(),n.delete(o),o.removeEventListener("dispose",y)};var p=y;f!==void 0&&f.texture.dispose();const _=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],S=o.morphAttributes.color||[];let E=0;_===!0&&(E=1),x===!0&&(E=2),m===!0&&(E=3);let A=o.attributes.position.count*E,w=1;A>e.maxTextureSize&&(w=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const C=new Float32Array(A*w*4*h),F=new yc(C,A,w,h);F.type=ln,F.needsUpdate=!0;const v=E*4;for(let L=0;L<h;L++){const G=d[L],B=b[L],j=S[L],X=A*w*4*L;for(let k=0;k<G.count;k++){const V=k*v;_===!0&&(s.fromBufferAttribute(G,k),C[X+V+0]=s.x,C[X+V+1]=s.y,C[X+V+2]=s.z,C[X+V+3]=0),x===!0&&(s.fromBufferAttribute(B,k),C[X+V+4]=s.x,C[X+V+5]=s.y,C[X+V+6]=s.z,C[X+V+7]=0),m===!0&&(s.fromBufferAttribute(j,k),C[X+V+8]=s.x,C[X+V+9]=s.y,C[X+V+10]=s.z,C[X+V+11]=j.itemSize===4?s.w:1)}}f={count:h,texture:F,size:new Le(A,w)},n.set(o,f),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const x=o.morphTargetsRelative?1:1-_;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function yp(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(s.get(h)!==c&&(e.update(h),s.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return h}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}const Ep={[rc]:"LINEAR_TONE_MAPPING",[ac]:"REINHARD_TONE_MAPPING",[oc]:"CINEON_TONE_MAPPING",[lc]:"ACES_FILMIC_TONE_MAPPING",[uc]:"AGX_TONE_MAPPING",[hc]:"NEUTRAL_TONE_MAPPING",[cc]:"CUSTOM_TONE_MAPPING"};function bp(i,e,t,n,s){const r=new hn(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),a=new hn(e,t,{type:Tn,depthBuffer:!1,stencilBuffer:!1}),o=new yt;o.setAttribute("position",new lt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new lt([0,2,0,0,2,0],2));const l=new dh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+d);const S=b+m+a,E=b+d+o,A=pl(s,s.VERTEX_SHADER,S),w=pl(s,s.FRAGMENT_SHADER,E);s.attachShader(x,A),s.attachShader(x,w),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(L){if(i.debug.checkShaderErrors){const G=s.getProgramInfoLog(x)||"",B=s.getShaderInfoLog(A)||"",j=s.getShaderInfoLog(w)||"",X=G.trim(),k=B.trim(),V=j.trim();let $=!0,he=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,A,w);else{const oe=gl(s,A,"vertex"),de=gl(s,w,"fragment");qe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+X+`
`+oe+`
`+de)}else X!==""?Re("WebGLProgram: Program Info Log:",X):(k===""||V==="")&&(he=!1);he&&(L.diagnostics={runnable:$,programLog:X,vertexShader:{log:k,prefix:m},fragmentShader:{log:V,prefix:d}})}s.deleteShader(A),s.deleteShader(w),F=new Xs(s,x),v=Tm(s,x)}let F;this.getUniforms=function(){return F===void 0&&C(this),F};let v;this.getAttributes=function(){return v===void 0&&C(this),v};let y=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=s.getProgramParameter(x,mm)),y},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=gm++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=A,this.fragmentShader=w,this}let Gm=0;class Hm{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new km(e),t.set(e,n)),n}}class km{constructor(e){this.id=Gm++,this.code=e,this.usedTimes=0}}function Wm(i,e,t,n,s,r,a){const o=new Ec,l=new Hm,c=new Set,u=[],h=new Map,f=s.logarithmicDepthBuffer;let p=s.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(v){return c.add(v),v===0?"uv":`uv${v}`}function m(v,y,L,G,B){const j=G.fog,X=B.geometry,k=v.isMeshStandardMaterial?G.environment:null,V=(v.isMeshStandardMaterial?t:e).get(v.envMap||k),$=V&&V.mapping===ir?V.image.height:null,he=_[v.type];v.precision!==null&&(p=s.getMaxPrecision(v.precision),p!==v.precision&&Re("WebGLProgram.getParameters:",v.precision,"not supported, using",p,"instead."));const oe=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,de=oe!==void 0?oe.length:0;let ze=0;X.morphAttributes.position!==void 0&&(ze=1),X.morphAttributes.normal!==void 0&&(ze=2),X.morphAttributes.color!==void 0&&(ze=3);let Ne,ct,at,Y;if(he){const Ze=rn[he];Ne=Ze.vertexShader,ct=Ze.fragmentShader}else Ne=v.vertexShader,ct=v.fragmentShader,l.update(v),at=l.getVertexShaderID(v),Y=l.getFragmentShaderID(v);const J=i.getRenderTarget(),me=i.state.buffers.depth.getReversed(),De=B.isInstancedMesh===!0,xe=B.isBatchedMesh===!0,We=!!v.map,vt=!!v.matcap,He=!!V,je=!!v.aoMap,et=!!v.lightMap,Fe=!!v.bumpMap,ft=!!v.normalMap,R=!!v.displacementMap,pt=!!v.emissiveMap,Ye=!!v.metalnessMap,nt=!!v.roughnessMap,Me=v.anisotropy>0,T=v.clearcoat>0,g=v.dispersion>0,I=v.iridescence>0,W=v.sheen>0,K=v.transmission>0,H=Me&&!!v.anisotropyMap,ye=T&&!!v.clearcoatMap,ie=T&&!!v.clearcoatNormalMap,ve=T&&!!v.clearcoatRoughnessMap,Ce=I&&!!v.iridescenceMap,ee=I&&!!v.iridescenceThicknessMap,re=W&&!!v.sheenColorMap,_e=W&&!!v.sheenRoughnessMap,Se=!!v.specularMap,se=!!v.specularColorMap,Oe=!!v.specularIntensityMap,P=K&&!!v.transmissionMap,ue=K&&!!v.thicknessMap,te=!!v.gradientMap,fe=!!v.alphaMap,Q=v.alphaTest>0,Z=!!v.alphaHash,ne=!!v.extensions;let Pe=un;v.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Pe=i.toneMapping);const it={shaderID:he,shaderType:v.type,shaderName:v.name,vertexShader:Ne,fragmentShader:ct,defines:v.defines,customVertexShaderID:at,customFragmentShaderID:Y,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:p,batching:xe,batchingColor:xe&&B._colorsTexture!==null,instancing:De,instancingColor:De&&B.instanceColor!==null,instancingMorph:De&&B.morphTexture!==null,outputColorSpace:J===null?i.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:Li,alphaToCoverage:!!v.alphaToCoverage,map:We,matcap:vt,envMap:He,envMapMode:He&&V.mapping,envMapCubeUVHeight:$,aoMap:je,lightMap:et,bumpMap:Fe,normalMap:ft,displacementMap:R,emissiveMap:pt,normalMapObjectSpace:ft&&v.normalMapType===Eu,normalMapTangentSpace:ft&&v.normalMapType===Mc,metalnessMap:Ye,roughnessMap:nt,anisotropy:Me,anisotropyMap:H,clearcoat:T,clearcoatMap:ye,clearcoatNormalMap:ie,clearcoatRoughnessMap:ve,dispersion:g,iridescence:I,iridescenceMap:Ce,iridescenceThicknessMap:ee,sheen:W,sheenColorMap:re,sheenRoughnessMap:_e,specularMap:Se,specularColorMap:se,specularIntensityMap:Oe,transmission:K,transmissionMap:P,thicknessMap:ue,gradientMap:te,opaque:v.transparent===!1&&v.blending===on&&v.alphaToCoverage===!1,alphaMap:fe,alphaTest:Q,alphaHash:Z,combine:v.combine,mapUv:We&&x(v.map.channel),aoMapUv:je&&x(v.aoMap.channel),lightMapUv:et&&x(v.lightMap.channel),bumpMapUv:Fe&&x(v.bumpMap.channel),normalMapUv:ft&&x(v.normalMap.channel),displacementMapUv:R&&x(v.displacementMap.channel),emissiveMapUv:pt&&x(v.emissiveMap.channel),metalnessMapUv:Ye&&x(v.metalnessMap.channel),roughnessMapUv:nt&&x(v.roughnessMap.channel),anisotropyMapUv:H&&x(v.anisotropyMap.channel),clearcoatMapUv:ye&&x(v.clearcoatMap.channel),clearcoatNormalMapUv:ie&&x(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ve&&x(v.clearcoatRoughnessMap.channel),iridescenceMapUv:Ce&&x(v.iridescenceMap.channel),iridescenceThicknessMapUv:ee&&x(v.iridescenceThicknessMap.channel),sheenColorMapUv:re&&x(v.sheenColorMap.channel),sheenRoughnessMapUv:_e&&x(v.sheenRoughnessMap.channel),specularMapUv:Se&&x(v.specularMap.channel),specularColorMapUv:se&&x(v.specularColorMap.channel),specularIntensityMapUv:Oe&&x(v.specularIntensityMap.channel),transmissionMapUv:P&&x(v.transmissionMap.channel),thicknessMapUv:ue&&x(v.thicknessMap.channel),alphaMapUv:fe&&x(v.alphaMap.channel),vertexTangents:!!X.attributes.tangent&&(ft||Me),vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!X.attributes.uv&&(We||fe),fog:!!j,useFog:v.fog===!0,fogExp2:!!j&&j.isFogExp2,flatShading:v.flatShading===!0&&v.wireframe===!1,sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:me,skinning:B.isSkinnedMesh===!0,morphTargets:X.morphAttributes.position!==void 0,morphNormals:X.morphAttributes.normal!==void 0,morphColors:X.morphAttributes.color!==void 0,morphTargetsCount:de,morphTextureStride:ze,numDirLights:y.directional.length,numPointLights:y.point.length,numSpotLights:y.spot.length,numSpotLightMaps:y.spotLightMap.length,numRectAreaLights:y.rectArea.length,numHemiLights:y.hemi.length,numDirLightShadows:y.directionalShadowMap.length,numPointLightShadows:y.pointShadowMap.length,numSpotLightShadows:y.spotShadowMap.length,numSpotLightShadowsWithMaps:y.numSpotLightShadowsWithMaps,numLightProbes:y.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:v.dithering,shadowMapEnabled:i.shadowMap.enabled&&L.length>0,shadowMapType:i.shadowMap.type,toneMapping:Pe,decodeVideoTexture:We&&v.map.isVideoTexture===!0&&ke.getTransfer(v.map.colorSpace)===$e,decodeVideoTextureEmissive:pt&&v.emissiveMap.isVideoTexture===!0&&ke.getTransfer(v.emissiveMap.colorSpace)===$e,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===an,flipSided:v.side===Bt,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:ne&&v.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ne&&v.extensions.multiDraw===!0||xe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return it.vertexUv1s=c.has(1),it.vertexUv2s=c.has(2),it.vertexUv3s=c.has(3),c.clear(),it}function d(v){const y=[];if(v.shaderID?y.push(v.shaderID):(y.push(v.customVertexShaderID),y.push(v.customFragmentShaderID)),v.defines!==void 0)for(const L in v.defines)y.push(L),y.push(v.defines[L]);return v.isRawShaderMaterial===!1&&(b(y,v),S(y,v),y.push(i.outputColorSpace)),y.push(v.customProgramCacheKey),y.join()}function b(v,y){v.push(y.precision),v.push(y.outputColorSpace),v.push(y.envMapMode),v.push(y.envMapCubeUVHeight),v.push(y.mapUv),v.push(y.alphaMapUv),v.push(y.lightMapUv),v.push(y.aoMapUv),v.push(y.bumpMapUv),v.push(y.normalMapUv),v.push(y.displacementMapUv),v.push(y.emissiveMapUv),v.push(y.metalnessMapUv),v.push(y.roughnessMapUv),v.push(y.anisotropyMapUv),v.push(y.clearcoatMapUv),v.push(y.clearcoatNormalMapUv),v.push(y.clearcoatRoughnessMapUv),v.push(y.iridescenceMapUv),v.push(y.iridescenceThicknessMapUv),v.push(y.sheenColorMapUv),v.push(y.sheenRoughnessMapUv),v.push(y.specularMapUv),v.push(y.specularColorMapUv),v.push(y.specularIntensityMapUv),v.push(y.transmissionMapUv),v.push(y.thicknessMapUv),v.push(y.combine),v.push(y.fogExp2),v.push(y.sizeAttenuation),v.push(y.morphTargetsCount),v.push(y.morphAttributeCount),v.push(y.numDirLights),v.push(y.numPointLights),v.push(y.numSpotLights),v.push(y.numSpotLightMaps),v.push(y.numHemiLights),v.push(y.numRectAreaLights),v.push(y.numDirLightShadows),v.push(y.numPointLightShadows),v.push(y.numSpotLightShadows),v.push(y.numSpotLightShadowsWithMaps),v.push(y.numLightProbes),v.push(y.shadowMapType),v.push(y.toneMapping),v.push(y.numClippingPlanes),v.push(y.numClipIntersection),v.push(y.depthPacking)}function S(v,y){o.disableAll(),y.instancing&&o.enable(0),y.instancingColor&&o.enable(1),y.instancingMorph&&o.enable(2),y.matcap&&o.enable(3),y.envMap&&o.enable(4),y.normalMapObjectSpace&&o.enable(5),y.normalMapTangentSpace&&o.enable(6),y.clearcoat&&o.enable(7),y.iridescence&&o.enable(8),y.alphaTest&&o.enable(9),y.vertexColors&&o.enable(10),y.vertexAlphas&&o.enable(11),y.vertexUv1s&&o.enable(12),y.vertexUv2s&&o.enable(13),y.vertexUv3s&&o.enable(14),y.vertexTangents&&o.enable(15),y.anisotropy&&o.enable(16),y.alphaHash&&o.enable(17),y.batching&&o.enable(18),y.dispersion&&o.enable(19),y.batchingColor&&o.enable(20),y.gradientMap&&o.enable(21),v.push(o.mask),o.disableAll(),y.fog&&o.enable(0),y.useFog&&o.enable(1),y.flatShading&&o.enable(2),y.logarithmicDepthBuffer&&o.enable(3),y.reversedDepthBuffer&&o.enable(4),y.skinning&&o.enable(5),y.morphTargets&&o.enable(6),y.morphNormals&&o.enable(7),y.morphColors&&o.enable(8),y.premultipliedAlpha&&o.enable(9),y.shadowMapEnabled&&o.enable(10),y.doubleSided&&o.enable(11),y.flipSided&&o.enable(12),y.useDepthPacking&&o.enable(13),y.dithering&&o.enable(14),y.transmission&&o.enable(15),y.sheen&&o.enable(16),y.opaque&&o.enable(17),y.pointsUvs&&o.enable(18),y.decodeVideoTexture&&o.enable(19),y.decodeVideoTextureEmissive&&o.enable(20),y.alphaToCoverage&&o.enable(21),v.push(o.mask)}function E(v){const y=_[v.type];let L;if(y){const G=rn[y];L=Ju.clone(G.uniforms)}else L=v.uniforms;return L}function A(v,y){let L=h.get(y);return L!==void 0?++L.usedTimes:(L=new Vm(i,y,v,r),u.push(L),h.set(y,L)),L}function w(v){if(--v.usedTimes===0){const y=u.indexOf(v);u[y]=u[u.length-1],u.pop(),h.delete(v.cacheKey),v.destroy()}}function C(v){l.remove(v)}function F(){l.dispose()}return{getParameters:m,getProgramCacheKey:d,getUniforms:E,acquireProgram:A,releaseProgram:w,releaseShaderCache:C,programs:u,dispose:F}}function Xm(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function qm(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Sl(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function yl(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(h,f,p,_,x,m){let d=i[e];return d===void 0?(d={id:h.id,object:h,geometry:f,material:p,groupOrder:_,renderOrder:h.renderOrder,z:x,group:m},i[e]=d):(d.id=h.id,d.object=h,d.geometry=f,d.material=p,d.groupOrder=_,d.renderOrder=h.renderOrder,d.z=x,d.group=m),e++,d}function o(h,f,p,_,x,m){const d=a(h,f,p,_,x,m);p.transmission>0?n.push(d):p.transparent===!0?s.push(d):t.push(d)}function l(h,f,p,_,x,m){const d=a(h,f,p,_,x,m);p.transmission>0?n.unshift(d):p.transparent===!0?s.unshift(d):t.unshift(d)}function c(h,f){t.length>1&&t.sort(h||qm),n.length>1&&n.sort(f||Sl),s.length>1&&s.sort(f||Sl)}function u(){for(let h=e,f=i.length;h<f;h++){const p=i[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:o,unshift:l,finish:u,sort:c}}function Ym(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new yl,i.set(n,[a])):s>=r.length?(a=new yl,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function jm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new Be};break;case"SpotLight":t={position:new D,direction:new D,color:new Be,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new Be,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new Be,groundColor:new Be};break;case"RectAreaLight":t={color:new Be,position:new D,halfWidth:new D,halfHeight:new D};break}return i[e.id]=t,t}}}function Zm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Le};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Le};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Le,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Km=0;function $m(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Jm(i){const e=new jm,t=Zm(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new D);const s=new D,r=new ot,a=new ot;function o(c){let u=0,h=0,f=0;for(let v=0;v<9;v++)n.probe[v].set(0,0,0);let p=0,_=0,x=0,m=0,d=0,b=0,S=0,E=0,A=0,w=0,C=0;c.sort($m);for(let v=0,y=c.length;v<y;v++){const L=c[v],G=L.color,B=L.intensity,j=L.distance;let X=null;if(L.shadow&&L.shadow.map&&(L.shadow.map.texture.format===Pi?X=L.shadow.map.texture:X=L.shadow.map.depthTexture||L.shadow.map.texture),L.isAmbientLight)u+=G.r*B,h+=G.g*B,f+=G.b*B;else if(L.isLightProbe){for(let k=0;k<9;k++)n.probe[k].addScaledVector(L.sh.coefficients[k],B);C++}else if(L.isDirectionalLight){const k=e.get(L);if(k.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){const V=L.shadow,$=t.get(L);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,n.directionalShadow[p]=$,n.directionalShadowMap[p]=X,n.directionalShadowMatrix[p]=L.shadow.matrix,b++}n.directional[p]=k,p++}else if(L.isSpotLight){const k=e.get(L);k.position.setFromMatrixPosition(L.matrixWorld),k.color.copy(G).multiplyScalar(B),k.distance=j,k.coneCos=Math.cos(L.angle),k.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),k.decay=L.decay,n.spot[x]=k;const V=L.shadow;if(L.map&&(n.spotLightMap[A]=L.map,A++,V.updateMatrices(L),L.castShadow&&w++),n.spotLightMatrix[x]=V.matrix,L.castShadow){const $=t.get(L);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,n.spotShadow[x]=$,n.spotShadowMap[x]=X,E++}x++}else if(L.isRectAreaLight){const k=e.get(L);k.color.copy(G).multiplyScalar(B),k.halfWidth.set(L.width*.5,0,0),k.halfHeight.set(0,L.height*.5,0),n.rectArea[m]=k,m++}else if(L.isPointLight){const k=e.get(L);if(k.color.copy(L.color).multiplyScalar(L.intensity),k.distance=L.distance,k.decay=L.decay,L.castShadow){const V=L.shadow,$=t.get(L);$.shadowIntensity=V.intensity,$.shadowBias=V.bias,$.shadowNormalBias=V.normalBias,$.shadowRadius=V.radius,$.shadowMapSize=V.mapSize,$.shadowCameraNear=V.camera.near,$.shadowCameraFar=V.camera.far,n.pointShadow[_]=$,n.pointShadowMap[_]=X,n.pointShadowMatrix[_]=L.shadow.matrix,S++}n.point[_]=k,_++}else if(L.isHemisphereLight){const k=e.get(L);k.skyColor.copy(L.color).multiplyScalar(B),k.groundColor.copy(L.groundColor).multiplyScalar(B),n.hemi[d]=k,d++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=le.LTC_FLOAT_1,n.rectAreaLTC2=le.LTC_FLOAT_2):(n.rectAreaLTC1=le.LTC_HALF_1,n.rectAreaLTC2=le.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=f;const F=n.hash;(F.directionalLength!==p||F.pointLength!==_||F.spotLength!==x||F.rectAreaLength!==m||F.hemiLength!==d||F.numDirectionalShadows!==b||F.numPointShadows!==S||F.numSpotShadows!==E||F.numSpotMaps!==A||F.numLightProbes!==C)&&(n.directional.length=p,n.spot.length=x,n.rectArea.length=m,n.point.length=_,n.hemi.length=d,n.directionalShadow.length=b,n.directionalShadowMap.length=b,n.pointShadow.length=S,n.pointShadowMap.length=S,n.spotShadow.length=E,n.spotShadowMap.length=E,n.directionalShadowMatrix.length=b,n.pointShadowMatrix.length=S,n.spotLightMatrix.length=E+A-w,n.spotLightMap.length=A,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=C,F.directionalLength=p,F.pointLength=_,F.spotLength=x,F.rectAreaLength=m,F.hemiLength=d,F.numDirectionalShadows=b,F.numPointShadows=S,F.numSpotShadows=E,F.numSpotMaps=A,F.numLightProbes=C,n.version=Km++)}function l(c,u){let h=0,f=0,p=0,_=0,x=0;const m=u.matrixWorldInverse;for(let d=0,b=c.length;d<b;d++){const S=c[d];if(S.isDirectionalLight){const E=n.directional[h];E.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(m),h++}else if(S.isSpotLight){const E=n.spot[p];E.position.setFromMatrixPosition(S.matrixWorld),E.position.applyMatrix4(m),E.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(m),p++}else if(S.isRectAreaLight){const E=n.rectArea[_];E.position.setFromMatrixPosition(S.matrixWorld),E.position.applyMatrix4(m),a.identity(),r.copy(S.matrixWorld),r.premultiply(m),a.extractRotation(r),E.halfWidth.set(S.width*.5,0,0),E.halfHeight.set(0,S.height*.5,0),E.halfWidth.applyMatrix4(a),E.halfHeight.applyMatrix4(a),_++}else if(S.isPointLight){const E=n.point[f];E.position.setFromMatrixPosition(S.matrixWorld),E.position.applyMatrix4(m),f++}else if(S.isHemisphereLight){const E=n.hemi[x];E.direction.setFromMatrixPosition(S.matrixWorld),E.direction.transformDirection(m),x++}}}return{setup:o,setupView:l,state:n}}function El(i){const e=new Jm(i),t=[],n=[];function s(u){c.camera=u,t.length=0,n.length=0}function r(u){t.push(u)}function a(u){n.push(u)}function o(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:a}}function Qm(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new El(i),e.set(s,[o])):r>=a.length?(o=new El(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const eg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,ng=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],ig=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],bl=new ot,Wi=new D,Hr=new D;function sg(i,e,t){let n=new ro;const s=new Le,r=new Le,a=new dt,o=new ph,l=new mh,c={},u=t.maxTextureSize,h={[On]:Bt,[Bt]:On,[an]:an},f=new pn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Le},radius:{value:4}},vertexShader:eg,fragmentShader:tg}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new yt;_.setAttribute("position",new en(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Lt(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=zs;let d=this.type;this.render=function(w,C,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;w.type===iu&&(Re("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),w.type=zs);const v=i.getRenderTarget(),y=i.getActiveCubeFace(),L=i.getActiveMipmapLevel(),G=i.state;G.setBlending(En),G.buffers.depth.getReversed()===!0?G.buffers.color.setClear(0,0,0,0):G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const B=d!==this.type;B&&C.traverse(function(j){j.material&&(Array.isArray(j.material)?j.material.forEach(X=>X.needsUpdate=!0):j.material.needsUpdate=!0)});for(let j=0,X=w.length;j<X;j++){const k=w[j],V=k.shadow;if(V===void 0){Re("WebGLShadowMap:",k,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const $=V.getFrameExtents();if(s.multiply($),r.copy(V.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/$.x),s.x=r.x*$.x,V.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/$.y),s.y=r.y*$.y,V.mapSize.y=r.y)),V.map===null||B===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===Xi){if(k.isPointLight){Re("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new hn(s.x,s.y,{format:Pi,type:Tn,minFilter:At,magFilter:At,generateMipmaps:!1}),V.map.texture.name=k.name+".shadowMap",V.map.depthTexture=new Qi(s.x,s.y,ln),V.map.depthTexture.name=k.name+".shadowMapDepth",V.map.depthTexture.format=An,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=St,V.map.depthTexture.magFilter=St}else{k.isPointLight?(V.map=new Pc(s.x),V.map.depthTexture=new hh(s.x,dn)):(V.map=new hn(s.x,s.y),V.map.depthTexture=new Qi(s.x,s.y,dn)),V.map.depthTexture.name=k.name+".shadowMap",V.map.depthTexture.format=An;const oe=i.state.buffers.depth.getReversed();this.type===zs?(V.map.depthTexture.compareFunction=oe?no:to,V.map.depthTexture.minFilter=At,V.map.depthTexture.magFilter=At):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=St,V.map.depthTexture.magFilter=St)}V.camera.updateProjectionMatrix()}const he=V.map.isWebGLCubeRenderTarget?6:1;for(let oe=0;oe<he;oe++){if(V.map.isWebGLCubeRenderTarget)i.setRenderTarget(V.map,oe),i.clear();else{oe===0&&(i.setRenderTarget(V.map),i.clear());const de=V.getViewport(oe);a.set(r.x*de.x,r.y*de.y,r.x*de.z,r.y*de.w),G.viewport(a)}if(k.isPointLight){const de=V.camera,ze=V.matrix,Ne=k.distance||de.far;Ne!==de.far&&(de.far=Ne,de.updateProjectionMatrix()),Wi.setFromMatrixPosition(k.matrixWorld),de.position.copy(Wi),Hr.copy(de.position),Hr.add(ng[oe]),de.up.copy(ig[oe]),de.lookAt(Hr),de.updateMatrixWorld(),ze.makeTranslation(-Wi.x,-Wi.y,-Wi.z),bl.multiplyMatrices(de.projectionMatrix,de.matrixWorldInverse),V._frustum.setFromProjectionMatrix(bl,de.coordinateSystem,de.reversedDepth)}else V.updateMatrices(k);n=V.getFrustum(),E(C,F,V.camera,k,this.type)}V.isPointLightShadow!==!0&&this.type===Xi&&b(V,F),V.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(v,y,L)};function b(w,C){const F=e.update(x);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new hn(s.x,s.y,{format:Pi,type:Tn})),f.uniforms.shadow_pass.value=w.map.depthTexture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(C,null,F,f,x,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(C,null,F,p,x,null)}function S(w,C,F,v){let y=null;const L=F.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(L!==void 0)y=L;else if(y=F.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const G=y.uuid,B=C.uuid;let j=c[G];j===void 0&&(j={},c[G]=j);let X=j[B];X===void 0&&(X=y.clone(),j[B]=X,C.addEventListener("dispose",A)),y=X}if(y.visible=C.visible,y.wireframe=C.wireframe,v===Xi?y.side=C.shadowSide!==null?C.shadowSide:C.side:y.side=C.shadowSide!==null?C.shadowSide:h[C.side],y.alphaMap=C.alphaMap,y.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,y.map=C.map,y.clipShadows=C.clipShadows,y.clippingPlanes=C.clippingPlanes,y.clipIntersection=C.clipIntersection,y.displacementMap=C.displacementMap,y.displacementScale=C.displacementScale,y.displacementBias=C.displacementBias,y.wireframeLinewidth=C.wireframeLinewidth,y.linewidth=C.linewidth,F.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const G=i.properties.get(y);G.light=F}return y}function E(w,C,F,v,y){if(w.visible===!1)return;if(w.layers.test(C.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===Xi)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,w.matrixWorld);const B=e.update(w),j=w.material;if(Array.isArray(j)){const X=B.groups;for(let k=0,V=X.length;k<V;k++){const $=X[k],he=j[$.materialIndex];if(he&&he.visible){const oe=S(w,he,v,y);w.onBeforeShadow(i,w,C,F,B,oe,$),i.renderBufferDirect(F,null,B,oe,w,$),w.onAfterShadow(i,w,C,F,B,oe,$)}}}else if(j.visible){const X=S(w,j,v,y);w.onBeforeShadow(i,w,C,F,B,X,null),i.renderBufferDirect(F,null,B,X,w,null),w.onAfterShadow(i,w,C,F,B,X,null)}}const G=w.children;for(let B=0,j=G.length;B<j;B++)E(G[B],C,F,v,y)}function A(w){w.target.removeEventListener("dispose",A);for(const F in c){const v=c[F],y=w.target.uuid;y in v&&(v[y].dispose(),delete v[y])}}}const rg={[Jr]:Qr,[ea]:ia,[ta]:sa,[Ci]:na,[Qr]:Jr,[ia]:ea,[sa]:ta,[na]:Ci};function ag(i,e){function t(){let P=!1;const ue=new dt;let te=null;const fe=new dt(0,0,0,0);return{setMask:function(Q){te!==Q&&!P&&(i.colorMask(Q,Q,Q,Q),te=Q)},setLocked:function(Q){P=Q},setClear:function(Q,Z,ne,Pe,it){it===!0&&(Q*=Pe,Z*=Pe,ne*=Pe),ue.set(Q,Z,ne,Pe),fe.equals(ue)===!1&&(i.clearColor(Q,Z,ne,Pe),fe.copy(ue))},reset:function(){P=!1,te=null,fe.set(-1,0,0,0)}}}function n(){let P=!1,ue=!1,te=null,fe=null,Q=null;return{setReversed:function(Z){if(ue!==Z){const ne=e.get("EXT_clip_control");Z?ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.ZERO_TO_ONE_EXT):ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.NEGATIVE_ONE_TO_ONE_EXT),ue=Z;const Pe=Q;Q=null,this.setClear(Pe)}},getReversed:function(){return ue},setTest:function(Z){Z?J(i.DEPTH_TEST):me(i.DEPTH_TEST)},setMask:function(Z){te!==Z&&!P&&(i.depthMask(Z),te=Z)},setFunc:function(Z){if(ue&&(Z=rg[Z]),fe!==Z){switch(Z){case Jr:i.depthFunc(i.NEVER);break;case Qr:i.depthFunc(i.ALWAYS);break;case ea:i.depthFunc(i.LESS);break;case Ci:i.depthFunc(i.LEQUAL);break;case ta:i.depthFunc(i.EQUAL);break;case na:i.depthFunc(i.GEQUAL);break;case ia:i.depthFunc(i.GREATER);break;case sa:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}fe=Z}},setLocked:function(Z){P=Z},setClear:function(Z){Q!==Z&&(ue&&(Z=1-Z),i.clearDepth(Z),Q=Z)},reset:function(){P=!1,te=null,fe=null,Q=null,ue=!1}}}function s(){let P=!1,ue=null,te=null,fe=null,Q=null,Z=null,ne=null,Pe=null,it=null;return{setTest:function(Ze){P||(Ze?J(i.STENCIL_TEST):me(i.STENCIL_TEST))},setMask:function(Ze){ue!==Ze&&!P&&(i.stencilMask(Ze),ue=Ze)},setFunc:function(Ze,tn,mn){(te!==Ze||fe!==tn||Q!==mn)&&(i.stencilFunc(Ze,tn,mn),te=Ze,fe=tn,Q=mn)},setOp:function(Ze,tn,mn){(Z!==Ze||ne!==tn||Pe!==mn)&&(i.stencilOp(Ze,tn,mn),Z=Ze,ne=tn,Pe=mn)},setLocked:function(Ze){P=Ze},setClear:function(Ze){it!==Ze&&(i.clearStencil(Ze),it=Ze)},reset:function(){P=!1,ue=null,te=null,fe=null,Q=null,Z=null,ne=null,Pe=null,it=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,p=[],_=null,x=!1,m=null,d=null,b=null,S=null,E=null,A=null,w=null,C=new Be(0,0,0),F=0,v=!1,y=null,L=null,G=null,B=null,j=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,V=0;const $=i.getParameter(i.VERSION);$.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec($)[1]),k=V>=1):$.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),k=V>=2);let he=null,oe={};const de=i.getParameter(i.SCISSOR_BOX),ze=i.getParameter(i.VIEWPORT),Ne=new dt().fromArray(de),ct=new dt().fromArray(ze);function at(P,ue,te,fe){const Q=new Uint8Array(4),Z=i.createTexture();i.bindTexture(P,Z),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ne=0;ne<te;ne++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(ue,0,i.RGBA,1,1,fe,0,i.RGBA,i.UNSIGNED_BYTE,Q):i.texImage2D(ue+ne,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Q);return Z}const Y={};Y[i.TEXTURE_2D]=at(i.TEXTURE_2D,i.TEXTURE_2D,1),Y[i.TEXTURE_CUBE_MAP]=at(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Y[i.TEXTURE_2D_ARRAY]=at(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Y[i.TEXTURE_3D]=at(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),J(i.DEPTH_TEST),a.setFunc(Ci),Fe(!1),ft(So),J(i.CULL_FACE),je(En);function J(P){u[P]!==!0&&(i.enable(P),u[P]=!0)}function me(P){u[P]!==!1&&(i.disable(P),u[P]=!1)}function De(P,ue){return h[P]!==ue?(i.bindFramebuffer(P,ue),h[P]=ue,P===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ue),P===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ue),!0):!1}function xe(P,ue){let te=p,fe=!1;if(P){te=f.get(ue),te===void 0&&(te=[],f.set(ue,te));const Q=P.textures;if(te.length!==Q.length||te[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,ne=Q.length;Z<ne;Z++)te[Z]=i.COLOR_ATTACHMENT0+Z;te.length=Q.length,fe=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,fe=!0);fe&&i.drawBuffers(te)}function We(P){return _!==P?(i.useProgram(P),_=P,!0):!1}const vt={[Un]:i.FUNC_ADD,[su]:i.FUNC_SUBTRACT,[ru]:i.FUNC_REVERSE_SUBTRACT};vt[au]=i.MIN,vt[ou]=i.MAX;const He={[lu]:i.ZERO,[cu]:i.ONE,[uu]:i.SRC_COLOR,[Kr]:i.SRC_ALPHA,[pu]:i.SRC_ALPHA_SATURATE,[fu]:i.DST_COLOR,[hu]:i.DST_ALPHA,[nc]:i.ONE_MINUS_SRC_COLOR,[$r]:i.ONE_MINUS_SRC_ALPHA,[ic]:i.ONE_MINUS_DST_COLOR,[du]:i.ONE_MINUS_DST_ALPHA,[mu]:i.CONSTANT_COLOR,[gu]:i.ONE_MINUS_CONSTANT_COLOR,[_u]:i.CONSTANT_ALPHA,[xu]:i.ONE_MINUS_CONSTANT_ALPHA};function je(P,ue,te,fe,Q,Z,ne,Pe,it,Ze){if(P===En){x===!0&&(me(i.BLEND),x=!1);return}if(x===!1&&(J(i.BLEND),x=!0),P!==tc){if(P!==m||Ze!==v){if((d!==Un||E!==Un)&&(i.blendEquation(i.FUNC_ADD),d=Un,E=Un),Ze)switch(P){case on:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Zi:i.blendFunc(i.ONE,i.ONE);break;case yo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Eo:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:qe("WebGLState: Invalid blending: ",P);break}else switch(P){case on:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Zi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case yo:qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Eo:qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:qe("WebGLState: Invalid blending: ",P);break}b=null,S=null,A=null,w=null,C.set(0,0,0),F=0,m=P,v=Ze}return}Q=Q||ue,Z=Z||te,ne=ne||fe,(ue!==d||Q!==E)&&(i.blendEquationSeparate(vt[ue],vt[Q]),d=ue,E=Q),(te!==b||fe!==S||Z!==A||ne!==w)&&(i.blendFuncSeparate(He[te],He[fe],He[Z],He[ne]),b=te,S=fe,A=Z,w=ne),(Pe.equals(C)===!1||it!==F)&&(i.blendColor(Pe.r,Pe.g,Pe.b,it),C.copy(Pe),F=it),m=P,v=!1}function et(P,ue){P.side===an?me(i.CULL_FACE):J(i.CULL_FACE);let te=P.side===Bt;ue&&(te=!te),Fe(te),P.blending===on&&P.transparent===!1?je(En):je(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);const fe=P.stencilWrite;o.setTest(fe),fe&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),pt(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?J(i.SAMPLE_ALPHA_TO_COVERAGE):me(i.SAMPLE_ALPHA_TO_COVERAGE)}function Fe(P){y!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),y=P)}function ft(P){P!==tu?(J(i.CULL_FACE),P!==L&&(P===So?i.cullFace(i.BACK):P===nu?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):me(i.CULL_FACE),L=P}function R(P){P!==G&&(k&&i.lineWidth(P),G=P)}function pt(P,ue,te){P?(J(i.POLYGON_OFFSET_FILL),(B!==ue||j!==te)&&(i.polygonOffset(ue,te),B=ue,j=te)):me(i.POLYGON_OFFSET_FILL)}function Ye(P){P?J(i.SCISSOR_TEST):me(i.SCISSOR_TEST)}function nt(P){P===void 0&&(P=i.TEXTURE0+X-1),he!==P&&(i.activeTexture(P),he=P)}function Me(P,ue,te){te===void 0&&(he===null?te=i.TEXTURE0+X-1:te=he);let fe=oe[te];fe===void 0&&(fe={type:void 0,texture:void 0},oe[te]=fe),(fe.type!==P||fe.texture!==ue)&&(he!==te&&(i.activeTexture(te),he=te),i.bindTexture(P,ue||Y[P]),fe.type=P,fe.texture=ue)}function T(){const P=oe[he];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function g(){try{i.compressedTexImage2D(...arguments)}catch(P){qe("WebGLState:",P)}}function I(){try{i.compressedTexImage3D(...arguments)}catch(P){qe("WebGLState:",P)}}function W(){try{i.texSubImage2D(...arguments)}catch(P){qe("WebGLState:",P)}}function K(){try{i.texSubImage3D(...arguments)}catch(P){qe("WebGLState:",P)}}function H(){try{i.compressedTexSubImage2D(...arguments)}catch(P){qe("WebGLState:",P)}}function ye(){try{i.compressedTexSubImage3D(...arguments)}catch(P){qe("WebGLState:",P)}}function ie(){try{i.texStorage2D(...arguments)}catch(P){qe("WebGLState:",P)}}function ve(){try{i.texStorage3D(...arguments)}catch(P){qe("WebGLState:",P)}}function Ce(){try{i.texImage2D(...arguments)}catch(P){qe("WebGLState:",P)}}function ee(){try{i.texImage3D(...arguments)}catch(P){qe("WebGLState:",P)}}function re(P){Ne.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Ne.copy(P))}function _e(P){ct.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),ct.copy(P))}function Se(P,ue){let te=c.get(ue);te===void 0&&(te=new WeakMap,c.set(ue,te));let fe=te.get(P);fe===void 0&&(fe=i.getUniformBlockIndex(ue,P.name),te.set(P,fe))}function se(P,ue){const fe=c.get(ue).get(P);l.get(ue)!==fe&&(i.uniformBlockBinding(ue,fe,P.__bindingPointIndex),l.set(ue,fe))}function Oe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},he=null,oe={},h={},f=new WeakMap,p=[],_=null,x=!1,m=null,d=null,b=null,S=null,E=null,A=null,w=null,C=new Be(0,0,0),F=0,v=!1,y=null,L=null,G=null,B=null,j=null,Ne.set(0,0,i.canvas.width,i.canvas.height),ct.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:J,disable:me,bindFramebuffer:De,drawBuffers:xe,useProgram:We,setBlending:je,setMaterial:et,setFlipSided:Fe,setCullFace:ft,setLineWidth:R,setPolygonOffset:pt,setScissorTest:Ye,activeTexture:nt,bindTexture:Me,unbindTexture:T,compressedTexImage2D:g,compressedTexImage3D:I,texImage2D:Ce,texImage3D:ee,updateUBOMapping:Se,uniformBlockBinding:se,texStorage2D:ie,texStorage3D:ve,texSubImage2D:W,texSubImage3D:K,compressedTexSubImage2D:H,compressedTexSubImage3D:ye,scissor:re,viewport:_e,reset:Oe}}function og(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Le,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,g){return p?new OffscreenCanvas(T,g):$s("canvas")}function x(T,g,I){let W=1;const K=Me(T);if((K.width>I||K.height>I)&&(W=I/Math.max(K.width,K.height)),W<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const H=Math.floor(W*K.width),ye=Math.floor(W*K.height);h===void 0&&(h=_(H,ye));const ie=g?_(H,ye):h;return ie.width=H,ie.height=ye,ie.getContext("2d").drawImage(T,0,0,H,ye),Re("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+H+"x"+ye+")."),ie}else return"data"in T&&Re("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),T;return T}function m(T){return T.generateMipmaps}function d(T){i.generateMipmap(T)}function b(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(T,g,I,W,K=!1){if(T!==null){if(i[T]!==void 0)return i[T];Re("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let H=g;if(g===i.RED&&(I===i.FLOAT&&(H=i.R32F),I===i.HALF_FLOAT&&(H=i.R16F),I===i.UNSIGNED_BYTE&&(H=i.R8)),g===i.RED_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.R8UI),I===i.UNSIGNED_SHORT&&(H=i.R16UI),I===i.UNSIGNED_INT&&(H=i.R32UI),I===i.BYTE&&(H=i.R8I),I===i.SHORT&&(H=i.R16I),I===i.INT&&(H=i.R32I)),g===i.RG&&(I===i.FLOAT&&(H=i.RG32F),I===i.HALF_FLOAT&&(H=i.RG16F),I===i.UNSIGNED_BYTE&&(H=i.RG8)),g===i.RG_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RG8UI),I===i.UNSIGNED_SHORT&&(H=i.RG16UI),I===i.UNSIGNED_INT&&(H=i.RG32UI),I===i.BYTE&&(H=i.RG8I),I===i.SHORT&&(H=i.RG16I),I===i.INT&&(H=i.RG32I)),g===i.RGB_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RGB8UI),I===i.UNSIGNED_SHORT&&(H=i.RGB16UI),I===i.UNSIGNED_INT&&(H=i.RGB32UI),I===i.BYTE&&(H=i.RGB8I),I===i.SHORT&&(H=i.RGB16I),I===i.INT&&(H=i.RGB32I)),g===i.RGBA_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RGBA8UI),I===i.UNSIGNED_SHORT&&(H=i.RGBA16UI),I===i.UNSIGNED_INT&&(H=i.RGBA32UI),I===i.BYTE&&(H=i.RGBA8I),I===i.SHORT&&(H=i.RGBA16I),I===i.INT&&(H=i.RGBA32I)),g===i.RGB&&(I===i.UNSIGNED_INT_5_9_9_9_REV&&(H=i.RGB9_E5),I===i.UNSIGNED_INT_10F_11F_11F_REV&&(H=i.R11F_G11F_B10F)),g===i.RGBA){const ye=K?Zs:ke.getTransfer(W);I===i.FLOAT&&(H=i.RGBA32F),I===i.HALF_FLOAT&&(H=i.RGBA16F),I===i.UNSIGNED_BYTE&&(H=ye===$e?i.SRGB8_ALPHA8:i.RGBA8),I===i.UNSIGNED_SHORT_4_4_4_4&&(H=i.RGBA4),I===i.UNSIGNED_SHORT_5_5_5_1&&(H=i.RGB5_A1)}return(H===i.R16F||H===i.R32F||H===i.RG16F||H===i.RG32F||H===i.RGBA16F||H===i.RGBA32F)&&e.get("EXT_color_buffer_float"),H}function E(T,g){let I;return T?g===null||g===dn||g===$i?I=i.DEPTH24_STENCIL8:g===ln?I=i.DEPTH32F_STENCIL8:g===Ki&&(I=i.DEPTH24_STENCIL8,Re("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===dn||g===$i?I=i.DEPTH_COMPONENT24:g===ln?I=i.DEPTH_COMPONENT32F:g===Ki&&(I=i.DEPTH_COMPONENT16),I}function A(T,g){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==St&&T.minFilter!==At?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function w(T){const g=T.target;g.removeEventListener("dispose",w),F(g),g.isVideoTexture&&u.delete(g)}function C(T){const g=T.target;g.removeEventListener("dispose",C),y(g)}function F(T){const g=n.get(T);if(g.__webglInit===void 0)return;const I=T.source,W=f.get(I);if(W){const K=W[g.__cacheKey];K.usedTimes--,K.usedTimes===0&&v(T),Object.keys(W).length===0&&f.delete(I)}n.remove(T)}function v(T){const g=n.get(T);i.deleteTexture(g.__webglTexture);const I=T.source,W=f.get(I);delete W[g.__cacheKey],a.memory.textures--}function y(T){const g=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(g.__webglFramebuffer[W]))for(let K=0;K<g.__webglFramebuffer[W].length;K++)i.deleteFramebuffer(g.__webglFramebuffer[W][K]);else i.deleteFramebuffer(g.__webglFramebuffer[W]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[W])}else{if(Array.isArray(g.__webglFramebuffer))for(let W=0;W<g.__webglFramebuffer.length;W++)i.deleteFramebuffer(g.__webglFramebuffer[W]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let W=0;W<g.__webglColorRenderbuffer.length;W++)g.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[W]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const I=T.textures;for(let W=0,K=I.length;W<K;W++){const H=n.get(I[W]);H.__webglTexture&&(i.deleteTexture(H.__webglTexture),a.memory.textures--),n.remove(I[W])}n.remove(T)}let L=0;function G(){L=0}function B(){const T=L;return T>=s.maxTextures&&Re("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),L+=1,T}function j(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function X(T,g){const I=n.get(T);if(T.isVideoTexture&&Ye(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&I.__version!==T.version){const W=T.image;if(W===null)Re("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Re("WebGLRenderer: Texture marked for update but image is incomplete");else{Y(I,T,g);return}}else T.isExternalTexture&&(I.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,I.__webglTexture,i.TEXTURE0+g)}function k(T,g){const I=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&I.__version!==T.version){Y(I,T,g);return}else T.isExternalTexture&&(I.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,I.__webglTexture,i.TEXTURE0+g)}function V(T,g){const I=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&I.__version!==T.version){Y(I,T,g);return}t.bindTexture(i.TEXTURE_3D,I.__webglTexture,i.TEXTURE0+g)}function $(T,g){const I=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&I.__version!==T.version){J(I,T,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,I.__webglTexture,i.TEXTURE0+g)}const he={[oa]:i.REPEAT,[yn]:i.CLAMP_TO_EDGE,[la]:i.MIRRORED_REPEAT},oe={[St]:i.NEAREST,[Su]:i.NEAREST_MIPMAP_NEAREST,[ls]:i.NEAREST_MIPMAP_LINEAR,[At]:i.LINEAR,[hr]:i.LINEAR_MIPMAP_NEAREST,[jn]:i.LINEAR_MIPMAP_LINEAR},de={[bu]:i.NEVER,[Ru]:i.ALWAYS,[Tu]:i.LESS,[to]:i.LEQUAL,[Au]:i.EQUAL,[no]:i.GEQUAL,[wu]:i.GREATER,[Cu]:i.NOTEQUAL};function ze(T,g){if(g.type===ln&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===At||g.magFilter===hr||g.magFilter===ls||g.magFilter===jn||g.minFilter===At||g.minFilter===hr||g.minFilter===ls||g.minFilter===jn)&&Re("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,he[g.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,he[g.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,he[g.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,oe[g.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,oe[g.minFilter]),g.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,de[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===St||g.minFilter!==ls&&g.minFilter!==jn||g.type===ln&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Ne(T,g){let I=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",w));const W=g.source;let K=f.get(W);K===void 0&&(K={},f.set(W,K));const H=j(g);if(H!==T.__cacheKey){K[H]===void 0&&(K[H]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,I=!0),K[H].usedTimes++;const ye=K[T.__cacheKey];ye!==void 0&&(K[T.__cacheKey].usedTimes--,ye.usedTimes===0&&v(g)),T.__cacheKey=H,T.__webglTexture=K[H].texture}return I}function ct(T,g,I){return Math.floor(Math.floor(T/I)/g)}function at(T,g,I,W){const H=T.updateRanges;if(H.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,I,W,g.data);else{H.sort((ee,re)=>ee.start-re.start);let ye=0;for(let ee=1;ee<H.length;ee++){const re=H[ye],_e=H[ee],Se=re.start+re.count,se=ct(_e.start,g.width,4),Oe=ct(re.start,g.width,4);_e.start<=Se+1&&se===Oe&&ct(_e.start+_e.count-1,g.width,4)===se?re.count=Math.max(re.count,_e.start+_e.count-re.start):(++ye,H[ye]=_e)}H.length=ye+1;const ie=i.getParameter(i.UNPACK_ROW_LENGTH),ve=i.getParameter(i.UNPACK_SKIP_PIXELS),Ce=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let ee=0,re=H.length;ee<re;ee++){const _e=H[ee],Se=Math.floor(_e.start/4),se=Math.ceil(_e.count/4),Oe=Se%g.width,P=Math.floor(Se/g.width),ue=se,te=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Oe),i.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,Oe,P,ue,te,I,W,g.data)}T.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ie),i.pixelStorei(i.UNPACK_SKIP_PIXELS,ve),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ce)}}function Y(T,g,I){let W=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(W=i.TEXTURE_3D);const K=Ne(T,g),H=g.source;t.bindTexture(W,T.__webglTexture,i.TEXTURE0+I);const ye=n.get(H);if(H.version!==ye.__version||K===!0){t.activeTexture(i.TEXTURE0+I);const ie=ke.getPrimaries(ke.workingColorSpace),ve=g.colorSpace===Nn?null:ke.getPrimaries(g.colorSpace),Ce=g.colorSpace===Nn||ie===ve?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ce);let ee=x(g.image,!1,s.maxTextureSize);ee=nt(g,ee);const re=r.convert(g.format,g.colorSpace),_e=r.convert(g.type);let Se=S(g.internalFormat,re,_e,g.colorSpace,g.isVideoTexture);ze(W,g);let se;const Oe=g.mipmaps,P=g.isVideoTexture!==!0,ue=ye.__version===void 0||K===!0,te=H.dataReady,fe=A(g,ee);if(g.isDepthTexture)Se=E(g.format===Zn,g.type),ue&&(P?t.texStorage2D(i.TEXTURE_2D,1,Se,ee.width,ee.height):t.texImage2D(i.TEXTURE_2D,0,Se,ee.width,ee.height,0,re,_e,null));else if(g.isDataTexture)if(Oe.length>0){P&&ue&&t.texStorage2D(i.TEXTURE_2D,fe,Se,Oe[0].width,Oe[0].height);for(let Q=0,Z=Oe.length;Q<Z;Q++)se=Oe[Q],P?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,se.width,se.height,re,_e,se.data):t.texImage2D(i.TEXTURE_2D,Q,Se,se.width,se.height,0,re,_e,se.data);g.generateMipmaps=!1}else P?(ue&&t.texStorage2D(i.TEXTURE_2D,fe,Se,ee.width,ee.height),te&&at(g,ee,re,_e)):t.texImage2D(i.TEXTURE_2D,0,Se,ee.width,ee.height,0,re,_e,ee.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){P&&ue&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Se,Oe[0].width,Oe[0].height,ee.depth);for(let Q=0,Z=Oe.length;Q<Z;Q++)if(se=Oe[Q],g.format!==Qt)if(re!==null)if(P){if(te)if(g.layerUpdates.size>0){const ne=tl(se.width,se.height,g.format,g.type);for(const Pe of g.layerUpdates){const it=se.data.subarray(Pe*ne/se.data.BYTES_PER_ELEMENT,(Pe+1)*ne/se.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,Pe,se.width,se.height,1,re,it)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,se.width,se.height,ee.depth,re,se.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,Se,se.width,se.height,ee.depth,0,se.data,0,0);else Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?te&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,se.width,se.height,ee.depth,re,_e,se.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Q,Se,se.width,se.height,ee.depth,0,re,_e,se.data)}else{P&&ue&&t.texStorage2D(i.TEXTURE_2D,fe,Se,Oe[0].width,Oe[0].height);for(let Q=0,Z=Oe.length;Q<Z;Q++)se=Oe[Q],g.format!==Qt?re!==null?P?te&&t.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,se.width,se.height,re,se.data):t.compressedTexImage2D(i.TEXTURE_2D,Q,Se,se.width,se.height,0,se.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,se.width,se.height,re,_e,se.data):t.texImage2D(i.TEXTURE_2D,Q,Se,se.width,se.height,0,re,_e,se.data)}else if(g.isDataArrayTexture)if(P){if(ue&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Se,ee.width,ee.height,ee.depth),te)if(g.layerUpdates.size>0){const Q=tl(ee.width,ee.height,g.format,g.type);for(const Z of g.layerUpdates){const ne=ee.data.subarray(Z*Q/ee.data.BYTES_PER_ELEMENT,(Z+1)*Q/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,ee.width,ee.height,1,re,_e,ne)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,re,_e,ee.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Se,ee.width,ee.height,ee.depth,0,re,_e,ee.data);else if(g.isData3DTexture)P?(ue&&t.texStorage3D(i.TEXTURE_3D,fe,Se,ee.width,ee.height,ee.depth),te&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,re,_e,ee.data)):t.texImage3D(i.TEXTURE_3D,0,Se,ee.width,ee.height,ee.depth,0,re,_e,ee.data);else if(g.isFramebufferTexture){if(ue)if(P)t.texStorage2D(i.TEXTURE_2D,fe,Se,ee.width,ee.height);else{let Q=ee.width,Z=ee.height;for(let ne=0;ne<fe;ne++)t.texImage2D(i.TEXTURE_2D,ne,Se,Q,Z,0,re,_e,null),Q>>=1,Z>>=1}}else if(Oe.length>0){if(P&&ue){const Q=Me(Oe[0]);t.texStorage2D(i.TEXTURE_2D,fe,Se,Q.width,Q.height)}for(let Q=0,Z=Oe.length;Q<Z;Q++)se=Oe[Q],P?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,re,_e,se):t.texImage2D(i.TEXTURE_2D,Q,Se,re,_e,se);g.generateMipmaps=!1}else if(P){if(ue){const Q=Me(ee);t.texStorage2D(i.TEXTURE_2D,fe,Se,Q.width,Q.height)}te&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,re,_e,ee)}else t.texImage2D(i.TEXTURE_2D,0,Se,re,_e,ee);m(g)&&d(W),ye.__version=H.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function J(T,g,I){if(g.image.length!==6)return;const W=Ne(T,g),K=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+I);const H=n.get(K);if(K.version!==H.__version||W===!0){t.activeTexture(i.TEXTURE0+I);const ye=ke.getPrimaries(ke.workingColorSpace),ie=g.colorSpace===Nn?null:ke.getPrimaries(g.colorSpace),ve=g.colorSpace===Nn||ye===ie?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);const Ce=g.isCompressedTexture||g.image[0].isCompressedTexture,ee=g.image[0]&&g.image[0].isDataTexture,re=[];for(let Z=0;Z<6;Z++)!Ce&&!ee?re[Z]=x(g.image[Z],!0,s.maxCubemapSize):re[Z]=ee?g.image[Z].image:g.image[Z],re[Z]=nt(g,re[Z]);const _e=re[0],Se=r.convert(g.format,g.colorSpace),se=r.convert(g.type),Oe=S(g.internalFormat,Se,se,g.colorSpace),P=g.isVideoTexture!==!0,ue=H.__version===void 0||W===!0,te=K.dataReady;let fe=A(g,_e);ze(i.TEXTURE_CUBE_MAP,g);let Q;if(Ce){P&&ue&&t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Oe,_e.width,_e.height);for(let Z=0;Z<6;Z++){Q=re[Z].mipmaps;for(let ne=0;ne<Q.length;ne++){const Pe=Q[ne];g.format!==Qt?Se!==null?P?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne,0,0,Pe.width,Pe.height,Se,Pe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne,Oe,Pe.width,Pe.height,0,Pe.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne,0,0,Pe.width,Pe.height,Se,se,Pe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne,Oe,Pe.width,Pe.height,0,Se,se,Pe.data)}}}else{if(Q=g.mipmaps,P&&ue){Q.length>0&&fe++;const Z=Me(re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Oe,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(ee){P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,re[Z].width,re[Z].height,Se,se,re[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Oe,re[Z].width,re[Z].height,0,Se,se,re[Z].data);for(let ne=0;ne<Q.length;ne++){const it=Q[ne].image[Z].image;P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne+1,0,0,it.width,it.height,Se,se,it.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne+1,Oe,it.width,it.height,0,Se,se,it.data)}}else{P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Se,se,re[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Oe,Se,se,re[Z]);for(let ne=0;ne<Q.length;ne++){const Pe=Q[ne];P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne+1,0,0,Se,se,Pe.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne+1,Oe,Se,se,Pe.image[Z])}}}m(g)&&d(i.TEXTURE_CUBE_MAP),H.__version=K.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function me(T,g,I,W,K,H){const ye=r.convert(I.format,I.colorSpace),ie=r.convert(I.type),ve=S(I.internalFormat,ye,ie,I.colorSpace),Ce=n.get(g),ee=n.get(I);if(ee.__renderTarget=g,!Ce.__hasExternalTextures){const re=Math.max(1,g.width>>H),_e=Math.max(1,g.height>>H);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?t.texImage3D(K,H,ve,re,_e,g.depth,0,ye,ie,null):t.texImage2D(K,H,ve,re,_e,0,ye,ie,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),pt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,K,ee.__webglTexture,0,R(g)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,K,ee.__webglTexture,H),t.bindFramebuffer(i.FRAMEBUFFER,null)}function De(T,g,I){if(i.bindRenderbuffer(i.RENDERBUFFER,T),g.depthBuffer){const W=g.depthTexture,K=W&&W.isDepthTexture?W.type:null,H=E(g.stencilBuffer,K),ye=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;pt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(g),H,g.width,g.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(g),H,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,H,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ye,i.RENDERBUFFER,T)}else{const W=g.textures;for(let K=0;K<W.length;K++){const H=W[K],ye=r.convert(H.format,H.colorSpace),ie=r.convert(H.type),ve=S(H.internalFormat,ye,ie,H.colorSpace);pt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(g),ve,g.width,g.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(g),ve,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ve,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function xe(T,g,I){const W=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(g.depthTexture);if(K.__renderTarget=g,(!K.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),W){if(K.__webglInit===void 0&&(K.__webglInit=!0,g.depthTexture.addEventListener("dispose",w)),K.__webglTexture===void 0){K.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),ze(i.TEXTURE_CUBE_MAP,g.depthTexture);const Ce=r.convert(g.depthTexture.format),ee=r.convert(g.depthTexture.type);let re;g.depthTexture.format===An?re=i.DEPTH_COMPONENT24:g.depthTexture.format===Zn&&(re=i.DEPTH24_STENCIL8);for(let _e=0;_e<6;_e++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,re,g.width,g.height,0,Ce,ee,null)}}else X(g.depthTexture,0);const H=K.__webglTexture,ye=R(g),ie=W?i.TEXTURE_CUBE_MAP_POSITIVE_X+I:i.TEXTURE_2D,ve=g.depthTexture.format===Zn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===An)pt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ve,ie,H,0,ye):i.framebufferTexture2D(i.FRAMEBUFFER,ve,ie,H,0);else if(g.depthTexture.format===Zn)pt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ve,ie,H,0,ye):i.framebufferTexture2D(i.FRAMEBUFFER,ve,ie,H,0);else throw new Error("Unknown depthTexture format")}function We(T){const g=n.get(T),I=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const W=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),W){const K=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,W.removeEventListener("dispose",K)};W.addEventListener("dispose",K),g.__depthDisposeCallback=K}g.__boundDepthTexture=W}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(I)for(let W=0;W<6;W++)xe(g.__webglFramebuffer[W],T,W);else{const W=T.texture.mipmaps;W&&W.length>0?xe(g.__webglFramebuffer[0],T,0):xe(g.__webglFramebuffer,T,0)}else if(I){g.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[W]),g.__webglDepthbuffer[W]===void 0)g.__webglDepthbuffer[W]=i.createRenderbuffer(),De(g.__webglDepthbuffer[W],T,!1);else{const K=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,H=g.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,H),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,H)}}else{const W=T.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),De(g.__webglDepthbuffer,T,!1);else{const K=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,H=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,H),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,H)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function vt(T,g,I){const W=n.get(T);g!==void 0&&me(W.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),I!==void 0&&We(T)}function He(T){const g=T.texture,I=n.get(T),W=n.get(g);T.addEventListener("dispose",C);const K=T.textures,H=T.isWebGLCubeRenderTarget===!0,ye=K.length>1;if(ye||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=g.version,a.memory.textures++),H){I.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(g.mipmaps&&g.mipmaps.length>0){I.__webglFramebuffer[ie]=[];for(let ve=0;ve<g.mipmaps.length;ve++)I.__webglFramebuffer[ie][ve]=i.createFramebuffer()}else I.__webglFramebuffer[ie]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){I.__webglFramebuffer=[];for(let ie=0;ie<g.mipmaps.length;ie++)I.__webglFramebuffer[ie]=i.createFramebuffer()}else I.__webglFramebuffer=i.createFramebuffer();if(ye)for(let ie=0,ve=K.length;ie<ve;ie++){const Ce=n.get(K[ie]);Ce.__webglTexture===void 0&&(Ce.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&pt(T)===!1){I.__webglMultisampledFramebuffer=i.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ie=0;ie<K.length;ie++){const ve=K[ie];I.__webglColorRenderbuffer[ie]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,I.__webglColorRenderbuffer[ie]);const Ce=r.convert(ve.format,ve.colorSpace),ee=r.convert(ve.type),re=S(ve.internalFormat,Ce,ee,ve.colorSpace,T.isXRRenderTarget===!0),_e=R(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,_e,re,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,I.__webglColorRenderbuffer[ie])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(I.__webglDepthRenderbuffer=i.createRenderbuffer(),De(I.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(H){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),ze(i.TEXTURE_CUBE_MAP,g);for(let ie=0;ie<6;ie++)if(g.mipmaps&&g.mipmaps.length>0)for(let ve=0;ve<g.mipmaps.length;ve++)me(I.__webglFramebuffer[ie][ve],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,ve);else me(I.__webglFramebuffer[ie],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);m(g)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ye){for(let ie=0,ve=K.length;ie<ve;ie++){const Ce=K[ie],ee=n.get(Ce);let re=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(re=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,ee.__webglTexture),ze(re,Ce),me(I.__webglFramebuffer,T,Ce,i.COLOR_ATTACHMENT0+ie,re,0),m(Ce)&&d(re)}t.unbindTexture()}else{let ie=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ie=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ie,W.__webglTexture),ze(ie,g),g.mipmaps&&g.mipmaps.length>0)for(let ve=0;ve<g.mipmaps.length;ve++)me(I.__webglFramebuffer[ve],T,g,i.COLOR_ATTACHMENT0,ie,ve);else me(I.__webglFramebuffer,T,g,i.COLOR_ATTACHMENT0,ie,0);m(g)&&d(ie),t.unbindTexture()}T.depthBuffer&&We(T)}function je(T){const g=T.textures;for(let I=0,W=g.length;I<W;I++){const K=g[I];if(m(K)){const H=b(T),ye=n.get(K).__webglTexture;t.bindTexture(H,ye),d(H),t.unbindTexture()}}}const et=[],Fe=[];function ft(T){if(T.samples>0){if(pt(T)===!1){const g=T.textures,I=T.width,W=T.height;let K=i.COLOR_BUFFER_BIT;const H=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ye=n.get(T),ie=g.length>1;if(ie)for(let Ce=0;Ce<g.length;Ce++)t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer);const ve=T.texture.mipmaps;ve&&ve.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ye.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let Ce=0;Ce<g.length;Ce++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),ie){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ye.__webglColorRenderbuffer[Ce]);const ee=n.get(g[Ce]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ee,0)}i.blitFramebuffer(0,0,I,W,0,0,I,W,K,i.NEAREST),l===!0&&(et.length=0,Fe.length=0,et.push(i.COLOR_ATTACHMENT0+Ce),T.depthBuffer&&T.resolveDepthBuffer===!1&&(et.push(H),Fe.push(H),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Fe)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,et))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ie)for(let Ce=0;Ce<g.length;Ce++){t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.RENDERBUFFER,ye.__webglColorRenderbuffer[Ce]);const ee=n.get(g[Ce]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.TEXTURE_2D,ee,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function R(T){return Math.min(s.maxSamples,T.samples)}function pt(T){const g=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Ye(T){const g=a.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function nt(T,g){const I=T.colorSpace,W=T.format,K=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||I!==Li&&I!==Nn&&(ke.getTransfer(I)===$e?(W!==Qt||K!==Wt)&&Re("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):qe("WebGLTextures: Unsupported texture color space:",I)),g}function Me(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=G,this.setTexture2D=X,this.setTexture2DArray=k,this.setTexture3D=V,this.setTextureCube=$,this.rebindTextures=vt,this.setupRenderTarget=He,this.updateRenderTargetMipmap=je,this.updateMultisampleRenderTarget=ft,this.setupDepthRenderbuffer=We,this.setupFrameBufferTexture=me,this.useMultisampledRTT=pt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function lg(i,e){function t(n,s=Nn){let r;const a=ke.getTransfer(s);if(n===Wt)return i.UNSIGNED_BYTE;if(n===Ka)return i.UNSIGNED_SHORT_4_4_4_4;if(n===$a)return i.UNSIGNED_SHORT_5_5_5_1;if(n===mc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===gc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===fc)return i.BYTE;if(n===pc)return i.SHORT;if(n===Ki)return i.UNSIGNED_SHORT;if(n===Za)return i.INT;if(n===dn)return i.UNSIGNED_INT;if(n===ln)return i.FLOAT;if(n===Tn)return i.HALF_FLOAT;if(n===_c)return i.ALPHA;if(n===xc)return i.RGB;if(n===Qt)return i.RGBA;if(n===An)return i.DEPTH_COMPONENT;if(n===Zn)return i.DEPTH_STENCIL;if(n===vc)return i.RED;if(n===Ja)return i.RED_INTEGER;if(n===Pi)return i.RG;if(n===Qa)return i.RG_INTEGER;if(n===eo)return i.RGBA_INTEGER;if(n===Vs||n===Gs||n===Hs||n===ks)if(a===$e)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Vs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ks)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Vs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ks)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ca||n===ua||n===ha||n===da)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ca)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ua)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ha)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===da)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===fa||n===pa||n===ma||n===ga||n===_a||n===xa||n===va)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===fa||n===pa)return a===$e?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ma)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===ga)return r.COMPRESSED_R11_EAC;if(n===_a)return r.COMPRESSED_SIGNED_R11_EAC;if(n===xa)return r.COMPRESSED_RG11_EAC;if(n===va)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ma||n===Sa||n===ya||n===Ea||n===ba||n===Ta||n===Aa||n===wa||n===Ca||n===Ra||n===Pa||n===La||n===Da||n===Ia)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ma)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Sa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ya)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ea)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ba)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ta)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Aa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===wa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ca)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ra)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Pa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===La)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Da)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ia)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ua||n===Na||n===Fa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ua)return a===$e?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Na)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Fa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Oa||n===Ba||n===za||n===Va)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Oa)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ba)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===za)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Va)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===$i?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const cg=`
void main() {
...
`),e=e.replace(/\\n/g,`
`),e=e.replace(/\*\*(.*?)\*\*/g,'<strong style="color:#fff;">$1</strong>'),e=e.replace(/^#\s+(.*)$/gm,""),e=e.replace(/^##\s+(.*)$/gm,'<h4 style="color:#00f3ff; margin-top:15px; margin-bottom:5px; text-transform:uppercase;">$1</h4>'),e=e.replace(/^###\s+(.*)$/gm,'<h5 style="color:#fff; margin-top:10px; margin-bottom:5px; border-bottom:1px solid rgba(255,255,255,0.1); padding-bottom:2px;">$1</h5>'),e=e.replace(/\n/gm,"<br>"),e=e.replace(/<\/h4><br>/g,"</h4>"),e=e.replace(/<\/h5><br>/g,"</h5>"),e=e.replace(/^(<br>)*/,""),e=e.replace(/(<br>)*$/,""),e}function Vg(){const i=document.getElementById("btn-spin"),e=document.getElementById("btn-reset"),t=document.getElementById("btn-toggle-info"),n=document.getElementById("btn-pan");n&&n.addEventListener("click",()=>{const S=q.toggleAutoPan();n.classList.toggle("active",S)});const s=document.getElementById("palette-trigger"),r=document.getElementById("palette-menu"),a=document.querySelectorAll(".palette-option");s&&r&&(s.addEventListener("click",E=>{E.stopPropagation(),r.classList.toggle("hidden")}),document.querySelectorAll(".legend-label").forEach(E=>{E.addEventListener("click",A=>{A.stopPropagation(),s.click()})}),document.addEventListener("click",()=>{r.classList.add("hidden")}),a.forEach(E=>{E.addEventListener("click",A=>{A.stopPropagation();const w=E.dataset.palette;Xr=w,q&&q.setPalette(w),Ee&&Ee.setPalette(w),s.className=`gradient-bar ${w}`,r.classList.add("hidden")})}),s.className=`gradient-bar ${Xr}`),i&&i.addEventListener("click",()=>{const S=i.classList.toggle("active");q.setAutoRotate(S),Ee.setAutoRotate(S),i.textContent=S?"AUTO-ROTATE: ON":"AUTO-ROTATE: OFF"}),e&&e.addEventListener("click",()=>{q.resetView(),Ee.resetView()}),t&&(document.getElementById("btn-toggle-info").addEventListener("click",()=>{const S=document.querySelectorAll(".artifact-details");Us=!Us,S.forEach(E=>E.style.opacity=Us?"1":"0"),document.getElementById("btn-toggle-info").textContent=Us?"HIDE INFO":"SHOW INFO",setTimeout(()=>{q&&q.onResize(),Ee&&Ee.onResize()},300)}),window.innerWidth<900&&(document.querySelector(".ui-layer").classList.add("no-details"),t.textContent="SHOW INFO"));const o=document.getElementById("btn-about"),l=document.getElementById("about-modal"),c=document.getElementById("btn-close-about");o&&l&&(o.addEventListener("click",()=>l.classList.remove("hidden")),c&&c.addEventListener("click",()=>l.classList.add("hidden")),l.addEventListener("click",S=>{S.target===l&&l.classList.add("hidden")}));const u=document.getElementById("rot-speed");u&&u.addEventListener("input",S=>{const E=parseFloat(S.target.value);q&&q.setRotSpeed(E),Ee&&Ee.setRotSpeed(E)});const h=document.getElementById("pan-limit-min"),f=document.getElementById("pan-limit-max"),p=document.getElementById("pan-track");function _(){if(!h||!f||!p)return;let S=parseFloat(h.value),E=parseFloat(f.value);S>E-1&&(S=E-1,h.value=S);const A=parseFloat(h.min),w=parseFloat(h.max),C=(S-A)/(w-A)*100,F=(E-A)/(w-A)*100;p.style.left=C+"%",p.style.width=F-C+"%",q&&(q.setPanMin(S),q.setPanMax(E)),Ee&&(Ee.setPanMin(S),Ee.setPanMax(E))}h&&f&&(h.addEventListener("input",_),f.addEventListener("input",_),_());const x=document.getElementById("btn-movement"),m=document.getElementById("btn-perf"),d=document.getElementById("movement-controls"),b=document.getElementById("perf-controls");if(x&&m&&d&&b){x.addEventListener("click",()=>{const A=!x.classList.contains("open");x.classList.toggle("open",A),d.classList.toggle("open",A),m.classList.remove("open"),b.classList.remove("open")}),m.addEventListener("click",()=>{const A=!m.classList.contains("open");m.classList.toggle("open",A),b.classList.toggle("open",A),x.classList.remove("open"),d.classList.remove("open")});const S=document.createElement("div");S.className="control-group",S.innerHTML=`
    ...
    `,d.appendChild(S);const E=document.getElementById("initial-distance-slider");E&&E.addEventListener("input",A=>{const w=parseFloat(A.target.value);q&&q.setInitialDistanceMultiplier(w),Ee&&Ee.setInitialDistanceMultiplier(w),document.getElementById("initial-distance-display").textContent=w.toFixed(1),It("setting",{id:"initial-distance-slider",val:w})})}if(b){const S=document.createElement("div");S.className="control-group",S.innerHTML=`
