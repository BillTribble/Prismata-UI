...
`)+`
`+d);const S=b+m+a,E=b+d+o,A=pl(s,s.VERTEX_SHADER,S),w=pl(s,s.FRAGMENT_SHADER,E);s.attachShader(x,A),s.attachShader(x,w),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(P){if(i.debug.checkShaderErrors){const G=s.getProgramInfoLog(x)||"",O=s.getShaderInfoLog(A)||"",W=s.getShaderInfoLog(w)||"",X=G.trim(),k=O.trim(),z=W.trim();let $=!0,ce=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,A,w);else{const ie=gl(s,A,"vertex"),de=gl(s,w,"fragment");qe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,ng=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],ig=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],bl=new ot,Wi=new D,Hr=new D;function sg(i,e,t){let n=new ro;const s=new Le,r=new Le,a=new dt,o=new ph,l=new mh,c={},u=t.maxTextureSize,h={[On]:Bt,[Bt]:On,[an]:an},f=new pn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Le},radius:{value:4}},vertexShader:eg,fragmentShader:tg}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new yt;_.setAttribute("position",new en(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Lt(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=zs;let d=this.type;this.render=function(w,C,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;w.type===iu&&(Re("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),w.type=zs);const v=i.getRenderTarget(),y=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),G=i.state;G.setBlending(En),G.buffers.depth.getReversed()===!0?G.buffers.color.setClear(0,0,0,0):G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const O=d!==this.type;O&&C.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(X=>X.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,X=w.length;W<X;W++){const k=w[W],z=k.shadow;if(z===void 0){Re("WebGLShadowMap:",k,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const $=z.getFrameExtents();if(s.multiply($),r.copy(z.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/$.x),s.x=r.x*$.x,z.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/$.y),s.y=r.y*$.y,z.mapSize.y=r.y)),z.map===null||O===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Xi){if(k.isPointLight){Re("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new hn(s.x,s.y,{format:Pi,type:Tn,minFilter:At,magFilter:At,generateMipmaps:!1}),z.map.texture.name=k.name+".shadowMap",z.map.depthTexture=new Qi(s.x,s.y,ln),z.map.depthTexture.name=k.name+".shadowMapDepth",z.map.depthTexture.format=An,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=St,z.map.depthTexture.magFilter=St}else{k.isPointLight?(z.map=new Pc(s.x),z.map.depthTexture=new hh(s.x,dn)):(z.map=new hn(s.x,s.y),z.map.depthTexture=new Qi(s.x,s.y,dn)),z.map.depthTexture.name=k.name+".shadowMap",z.map.depthTexture.format=An;const ie=i.state.buffers.depth.getReversed();this.type===zs?(z.map.depthTexture.compareFunction=ie?no:to,z.map.depthTexture.minFilter=At,z.map.depthTexture.magFilter=At):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=St,z.map.depthTexture.magFilter=St)}z.camera.updateProjectionMatrix()}const ce=z.map.isWebGLCubeRenderTarget?6:1;for(let ie=0;ie<ce;ie++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,ie),i.clear();else{ie===0&&(i.setRenderTarget(z.map),i.clear());const de=z.getViewport(ie);a.set(r.x*de.x,r.y*de.y,r.x*de.z,r.y*de.w),G.viewport(a)}if(k.isPointLight){const de=z.camera,ze=z.matrix,Ne=k.distance||de.far;Ne!==de.far&&(de.far=Ne,de.updateProjectionMatrix()),Wi.setFromMatrixPosition(k.matrixWorld),de.position.copy(Wi),Hr.copy(de.position),Hr.add(ng[ie]),de.up.copy(ig[ie]),de.lookAt(Hr),de.updateMatrixWorld(),ze.makeTranslation(-Wi.x,-Wi.y,-Wi.z),bl.multiplyMatrices(de.projectionMatrix,de.matrixWorldInverse),z._frustum.setFromProjectionMatrix(bl,de.coordinateSystem,de.reversedDepth)}else z.updateMatrices(k);n=z.getFrustum(),E(C,F,z.camera,k,this.type)}z.isPointLightShadow!==!0&&this.type===Xi&&b(z,F),z.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(v,y,P)};function b(w,C){const F=e.update(x);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new hn(s.x,s.y,{format:Pi,type:Tn})),f.uniforms.shadow_pass.value=w.map.depthTexture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(C,null,F,f,x,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(C,null,F,p,x,null)}function S(w,C,F,v){let y=null;const P=F.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)y=P;else if(y=F.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const G=y.uuid,O=C.uuid;let W=c[G];W===void 0&&(W={},c[G]=W);let X=W[O];X===void 0&&(X=y.clone(),W[O]=X,C.addEventListener("dispose",A)),y=X}if(y.visible=C.visible,y.wireframe=C.wireframe,v===Xi?y.side=C.shadowSide!==null?C.shadowSide:C.side:y.side=C.shadowSide!==null?C.shadowSide:h[C.side],y.alphaMap=C.alphaMap,y.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,y.map=C.map,y.clipShadows=C.clipShadows,y.clippingPlanes=C.clippingPlanes,y.clipIntersection=C.clipIntersection,y.displacementMap=C.displacementMap,y.displacementScale=C.displacementScale,y.displacementBias=C.displacementBias,y.wireframeLinewidth=C.wireframeLinewidth,y.linewidth=C.linewidth,F.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const G=i.properties.get(y);G.light=F}return y}function E(w,C,F,v,y){if(w.visible===!1)return;if(w.layers.test(C.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===Xi)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,w.matrixWorld);const O=e.update(w),W=w.material;if(Array.isArray(W)){const X=O.groups;for(let k=0,z=X.length;k<z;k++){const $=X[k],ce=W[$.materialIndex];if(ce&&ce.visible){const ie=S(w,ce,v,y);w.onBeforeShadow(i,w,C,F,O,ie,$),i.renderBufferDirect(F,null,O,ie,w,$),w.onAfterShadow(i,w,C,F,O,ie,$)}}}else if(W.visible){const X=S(w,W,v,y);w.onBeforeShadow(i,w,C,F,O,X,null),i.renderBufferDirect(F,null,O,X,w,null),w.onAfterShadow(i,w,C,F,O,X,null)}}const G=w.children;for(let O=0,W=G.length;O<W;O++)E(G[O],C,F,v,y)}function A(w){w.target.removeEventListener("dispose",A);for(const F in c){const v=c[F],y=w.target.uuid;y in v&&(v[y].dispose(),delete v[y])}}}const rg={[Jr]:Qr,[ea]:ia,[ta]:sa,[Ci]:na,[Qr]:Jr,[ia]:ea,[sa]:ta,[na]:Ci};function ag(i,e){function t(){let L=!1;const he=new dt;let te=null;const fe=new dt(0,0,0,0);return{setMask:function(Q){te!==Q&&!L&&(i.colorMask(Q,Q,Q,Q),te=Q)},setLocked:function(Q){L=Q},setClear:function(Q,K,ne,Pe,it){it===!0&&(Q*=Pe,K*=Pe,ne*=Pe),he.set(Q,K,ne,Pe),fe.equals(he)===!1&&(i.clearColor(Q,K,ne,Pe),fe.copy(he))},reset:function(){L=!1,te=null,fe.set(-1,0,0,0)}}}function n(){let L=!1,he=!1,te=null,fe=null,Q=null;return{setReversed:function(K){if(he!==K){const ne=e.get("EXT_clip_control");K?ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.ZERO_TO_ONE_EXT):ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.NEGATIVE_ONE_TO_ONE_EXT),he=K;const Pe=Q;Q=null,this.setClear(Pe)}},getReversed:function(){return he},setTest:function(K){K?J(i.DEPTH_TEST):me(i.DEPTH_TEST)},setMask:function(K){te!==K&&!L&&(i.depthMask(K),te=K)},setFunc:function(K){if(he&&(K=rg[K]),fe!==K){switch(K){case Jr:i.depthFunc(i.NEVER);break;case Qr:i.depthFunc(i.ALWAYS);break;case ea:i.depthFunc(i.LESS);break;case Ci:i.depthFunc(i.LEQUAL);break;case ta:i.depthFunc(i.EQUAL);break;case na:i.depthFunc(i.GEQUAL);break;case ia:i.depthFunc(i.GREATER);break;case sa:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}fe=K}},setLocked:function(K){L=K},setClear:function(K){Q!==K&&(he&&(K=1-K),i.clearDepth(K),Q=K)},reset:function(){L=!1,te=null,fe=null,Q=null,he=!1}}}function s(){let L=!1,he=null,te=null,fe=null,Q=null,K=null,ne=null,Pe=null,it=null;return{setTest:function(Ke){L||(Ke?J(i.STENCIL_TEST):me(i.STENCIL_TEST))},setMask:function(Ke){he!==Ke&&!L&&(i.stencilMask(Ke),he=Ke)},setFunc:function(Ke,tn,mn){(te!==Ke||fe!==tn||Q!==mn)&&(i.stencilFunc(Ke,tn,mn),te=Ke,fe=tn,Q=mn)},setOp:function(Ke,tn,mn){(K!==Ke||ne!==tn||Pe!==mn)&&(i.stencilOp(Ke,tn,mn),K=Ke,ne=tn,Pe=mn)},setLocked:function(Ke){L=Ke},setClear:function(Ke){it!==Ke&&(i.clearStencil(Ke),it=Ke)},reset:function(){L=!1,he=null,te=null,fe=null,Q=null,K=null,ne=null,Pe=null,it=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,p=[],_=null,x=!1,m=null,d=null,b=null,S=null,E=null,A=null,w=null,C=new Be(0,0,0),F=0,v=!1,y=null,P=null,G=null,O=null,W=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,z=0;const $=i.getParameter(i.VERSION);$.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec($)[1]),k=z>=1):$.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),k=z>=2);let ce=null,ie={};const de=i.getParameter(i.SCISSOR_BOX),ze=i.getParameter(i.VIEWPORT),Ne=new dt().fromArray(de),ct=new dt().fromArray(ze);function at(L,he,te,fe){const Q=new Uint8Array(4),K=i.createTexture();i.bindTexture(L,K),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ne=0;ne<te;ne++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(he,0,i.RGBA,1,1,fe,0,i.RGBA,i.UNSIGNED_BYTE,Q):i.texImage2D(he+ne,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Q);return K}const j={};j[i.TEXTURE_2D]=at(i.TEXTURE_2D,i.TEXTURE_2D,1),j[i.TEXTURE_CUBE_MAP]=at(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[i.TEXTURE_2D_ARRAY]=at(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),j[i.TEXTURE_3D]=at(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),J(i.DEPTH_TEST),a.setFunc(Ci),Fe(!1),ft(So),J(i.CULL_FACE),je(En);function J(L){u[L]!==!0&&(i.enable(L),u[L]=!0)}function me(L){u[L]!==!1&&(i.disable(L),u[L]=!1)}function De(L,he){return h[L]!==he?(i.bindFramebuffer(L,he),h[L]=he,L===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=he),L===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=he),!0):!1}function xe(L,he){let te=p,fe=!1;if(L){te=f.get(he),te===void 0&&(te=[],f.set(he,te));const Q=L.textures;if(te.length!==Q.length||te[0]!==i.COLOR_ATTACHMENT0){for(let K=0,ne=Q.length;K<ne;K++)te[K]=i.COLOR_ATTACHMENT0+K;te.length=Q.length,fe=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,fe=!0);fe&&i.drawBuffers(te)}function We(L){return _!==L?(i.useProgram(L),_=L,!0):!1}const vt={[Un]:i.FUNC_ADD,[su]:i.FUNC_SUBTRACT,[ru]:i.FUNC_REVERSE_SUBTRACT};vt[au]=i.MIN,vt[ou]=i.MAX;const He={[lu]:i.ZERO,[cu]:i.ONE,[uu]:i.SRC_COLOR,[Zr]:i.SRC_ALPHA,[pu]:i.SRC_ALPHA_SATURATE,[fu]:i.DST_COLOR,[hu]:i.DST_ALPHA,[nc]:i.ONE_MINUS_SRC_COLOR,[$r]:i.ONE_MINUS_SRC_ALPHA,[ic]:i.ONE_MINUS_DST_COLOR,[du]:i.ONE_MINUS_DST_ALPHA,[mu]:i.CONSTANT_COLOR,[gu]:i.ONE_MINUS_CONSTANT_COLOR,[_u]:i.CONSTANT_ALPHA,[xu]:i.ONE_MINUS_CONSTANT_ALPHA};function je(L,he,te,fe,Q,K,ne,Pe,it,Ke){if(L===En){x===!0&&(me(i.BLEND),x=!1);return}if(x===!1&&(J(i.BLEND),x=!0),L!==tc){if(L!==m||Ke!==v){if((d!==Un||E!==Un)&&(i.blendEquation(i.FUNC_ADD),d=Un,E=Un),Ke)switch(L){case on:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ki:i.blendFunc(i.ONE,i.ONE);break;case yo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Eo:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:qe("WebGLState: Invalid blending: ",L);break}else switch(L){case on:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ki:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case yo:qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Eo:qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:qe("WebGLState: Invalid blending: ",L);break}b=null,S=null,A=null,w=null,C.set(0,0,0),F=0,m=L,v=Ke}return}Q=Q||he,K=K||te,ne=ne||fe,(he!==d||Q!==E)&&(i.blendEquationSeparate(vt[he],vt[Q]),d=he,E=Q),(te!==b||fe!==S||K!==A||ne!==w)&&(i.blendFuncSeparate(He[te],He[fe],He[K],He[ne]),b=te,S=fe,A=K,w=ne),(Pe.equals(C)===!1||it!==F)&&(i.blendColor(Pe.r,Pe.g,Pe.b,it),C.copy(Pe),F=it),m=L,v=!1}function et(L,he){L.side===an?me(i.CULL_FACE):J(i.CULL_FACE);let te=L.side===Bt;he&&(te=!te),Fe(te),L.blending===on&&L.transparent===!1?je(En):je(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),r.setMask(L.colorWrite);const fe=L.stencilWrite;o.setTest(fe),fe&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),pt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?J(i.SAMPLE_ALPHA_TO_COVERAGE):me(i.SAMPLE_ALPHA_TO_COVERAGE)}function Fe(L){y!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),y=L)}function ft(L){L!==tu?(J(i.CULL_FACE),L!==P&&(L===So?i.cullFace(i.BACK):L===nu?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):me(i.CULL_FACE),P=L}function R(L){L!==G&&(k&&i.lineWidth(L),G=L)}function pt(L,he,te){L?(J(i.POLYGON_OFFSET_FILL),(O!==he||W!==te)&&(i.polygonOffset(he,te),O=he,W=te)):me(i.POLYGON_OFFSET_FILL)}function Ye(L){L?J(i.SCISSOR_TEST):me(i.SCISSOR_TEST)}function nt(L){L===void 0&&(L=i.TEXTURE0+X-1),ce!==L&&(i.activeTexture(L),ce=L)}function Me(L,he,te){te===void 0&&(ce===null?te=i.TEXTURE0+X-1:te=ce);let fe=ie[te];fe===void 0&&(fe={type:void 0,texture:void 0},ie[te]=fe),(fe.type!==L||fe.texture!==he)&&(ce!==te&&(i.activeTexture(te),ce=te),i.bindTexture(L,he||j[L]),fe.type=L,fe.texture=he)}function T(){const L=ie[ce];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function g(){try{i.compressedTexImage2D(...arguments)}catch(L){qe("WebGLState:",L)}}function I(){try{i.compressedTexImage3D(...arguments)}catch(L){qe("WebGLState:",L)}}function q(){try{i.texSubImage2D(...arguments)}catch(L){qe("WebGLState:",L)}}function Z(){try{i.texSubImage3D(...arguments)}catch(L){qe("WebGLState:",L)}}function H(){try{i.compressedTexSubImage2D(...arguments)}catch(L){qe("WebGLState:",L)}}function ye(){try{i.compressedTexSubImage3D(...arguments)}catch(L){qe("WebGLState:",L)}}function se(){try{i.texStorage2D(...arguments)}catch(L){qe("WebGLState:",L)}}function ve(){try{i.texStorage3D(...arguments)}catch(L){qe("WebGLState:",L)}}function Ce(){try{i.texImage2D(...arguments)}catch(L){qe("WebGLState:",L)}}function ee(){try{i.texImage3D(...arguments)}catch(L){qe("WebGLState:",L)}}function ae(L){Ne.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),Ne.copy(L))}function _e(L){ct.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),ct.copy(L))}function Se(L,he){let te=c.get(he);te===void 0&&(te=new WeakMap,c.set(he,te));let fe=te.get(L);fe===void 0&&(fe=i.getUniformBlockIndex(he,L.name),te.set(L,fe))}function re(L,he){const fe=c.get(he).get(L);l.get(he)!==fe&&(i.uniformBlockBinding(he,fe,L.__bindingPointIndex),l.set(he,fe))}function Oe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},ce=null,ie={},h={},f=new WeakMap,p=[],_=null,x=!1,m=null,d=null,b=null,S=null,E=null,A=null,w=null,C=new Be(0,0,0),F=0,v=!1,y=null,P=null,G=null,O=null,W=null,Ne.set(0,0,i.canvas.width,i.canvas.height),ct.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:J,disable:me,bindFramebuffer:De,drawBuffers:xe,useProgram:We,setBlending:je,setMaterial:et,setFlipSided:Fe,setCullFace:ft,setLineWidth:R,setPolygonOffset:pt,setScissorTest:Ye,activeTexture:nt,bindTexture:Me,unbindTexture:T,compressedTexImage2D:g,compressedTexImage3D:I,texImage2D:Ce,texImage3D:ee,updateUBOMapping:Se,uniformBlockBinding:re,texStorage2D:se,texStorage3D:ve,texSubImage2D:q,texSubImage3D:Z,compressedTexSubImage2D:H,compressedTexSubImage3D:ye,scissor:ae,viewport:_e,reset:Oe}}function og(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Le,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,g){return p?new OffscreenCanvas(T,g):$s("canvas")}function x(T,g,I){let q=1;const Z=Me(T);if((Z.width>I||Z.height>I)&&(q=I/Math.max(Z.width,Z.height)),q<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const H=Math.floor(q*Z.width),ye=Math.floor(q*Z.height);h===void 0&&(h=_(H,ye));const se=g?_(H,ye):h;return se.width=H,se.height=ye,se.getContext("2d").drawImage(T,0,0,H,ye),Re("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+H+"x"+ye+")."),se}else return"data"in T&&Re("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),T;return T}function m(T){return T.generateMipmaps}function d(T){i.generateMipmap(T)}function b(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(T,g,I,q,Z=!1){if(T!==null){if(i[T]!==void 0)return i[T];Re("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let H=g;if(g===i.RED&&(I===i.FLOAT&&(H=i.R32F),I===i.HALF_FLOAT&&(H=i.R16F),I===i.UNSIGNED_BYTE&&(H=i.R8)),g===i.RED_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.R8UI),I===i.UNSIGNED_SHORT&&(H=i.R16UI),I===i.UNSIGNED_INT&&(H=i.R32UI),I===i.BYTE&&(H=i.R8I),I===i.SHORT&&(H=i.R16I),I===i.INT&&(H=i.R32I)),g===i.RG&&(I===i.FLOAT&&(H=i.RG32F),I===i.HALF_FLOAT&&(H=i.RG16F),I===i.UNSIGNED_BYTE&&(H=i.RG8)),g===i.RG_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RG8UI),I===i.UNSIGNED_SHORT&&(H=i.RG16UI),I===i.UNSIGNED_INT&&(H=i.RG32UI),I===i.BYTE&&(H=i.RG8I),I===i.SHORT&&(H=i.RG16I),I===i.INT&&(H=i.RG32I)),g===i.RGB_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RGB8UI),I===i.UNSIGNED_SHORT&&(H=i.RGB16UI),I===i.UNSIGNED_INT&&(H=i.RGB32UI),I===i.BYTE&&(H=i.RGB8I),I===i.SHORT&&(H=i.RGB16I),I===i.INT&&(H=i.RGB32I)),g===i.RGBA_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RGBA8UI),I===i.UNSIGNED_SHORT&&(H=i.RGBA16UI),I===i.UNSIGNED_INT&&(H=i.RGBA32UI),I===i.BYTE&&(H=i.RGBA8I),I===i.SHORT&&(H=i.RGBA16I),I===i.INT&&(H=i.RGBA32I)),g===i.RGB&&(I===i.UNSIGNED_INT_5_9_9_9_REV&&(H=i.RGB9_E5),I===i.UNSIGNED_INT_10F_11F_11F_REV&&(H=i.R11F_G11F_B10F)),g===i.RGBA){const ye=Z?Ks:ke.getTransfer(q);I===i.FLOAT&&(H=i.RGBA32F),I===i.HALF_FLOAT&&(H=i.RGBA16F),I===i.UNSIGNED_BYTE&&(H=ye===$e?i.SRGB8_ALPHA8:i.RGBA8),I===i.UNSIGNED_SHORT_4_4_4_4&&(H=i.RGBA4),I===i.UNSIGNED_SHORT_5_5_5_1&&(H=i.RGB5_A1)}return(H===i.R16F||H===i.R32F||H===i.RG16F||H===i.RG32F||H===i.RGBA16F||H===i.RGBA32F)&&e.get("EXT_color_buffer_float"),H}function E(T,g){let I;return T?g===null||g===dn||g===$i?I=i.DEPTH24_STENCIL8:g===ln?I=i.DEPTH32F_STENCIL8:g===Zi&&(I=i.DEPTH24_STENCIL8,Re("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===dn||g===$i?I=i.DEPTH_COMPONENT24:g===ln?I=i.DEPTH_COMPONENT32F:g===Zi&&(I=i.DEPTH_COMPONENT16),I}function A(T,g){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==St&&T.minFilter!==At?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function w(T){const g=T.target;g.removeEventListener("dispose",w),F(g),g.isVideoTexture&&u.delete(g)}function C(T){const g=T.target;g.removeEventListener("dispose",C),y(g)}function F(T){const g=n.get(T);if(g.__webglInit===void 0)return;const I=T.source,q=f.get(I);if(q){const Z=q[g.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&v(T),Object.keys(q).length===0&&f.delete(I)}n.remove(T)}function v(T){const g=n.get(T);i.deleteTexture(g.__webglTexture);const I=T.source,q=f.get(I);delete q[g.__cacheKey],a.memory.textures--}function y(T){const g=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(g.__webglFramebuffer[q]))for(let Z=0;Z<g.__webglFramebuffer[q].length;Z++)i.deleteFramebuffer(g.__webglFramebuffer[q][Z]);else i.deleteFramebuffer(g.__webglFramebuffer[q]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[q])}else{if(Array.isArray(g.__webglFramebuffer))for(let q=0;q<g.__webglFramebuffer.length;q++)i.deleteFramebuffer(g.__webglFramebuffer[q]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let q=0;q<g.__webglColorRenderbuffer.length;q++)g.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[q]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const I=T.textures;for(let q=0,Z=I.length;q<Z;q++){const H=n.get(I[q]);H.__webglTexture&&(i.deleteTexture(H.__webglTexture),a.memory.textures--),n.remove(I[q])}n.remove(T)}let P=0;function G(){P=0}function O(){const T=P;return T>=s.maxTextures&&Re("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),P+=1,T}function W(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function X(T,g){const I=n.get(T);if(T.isVideoTexture&&Ye(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&I.__version!==T.version){const q=T.image;if(q===null)Re("WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)Re("WebGLRenderer: Texture marked for update but image is incomplete");else{j(I,T,g);return}}else T.isExternalTexture&&(I.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,I.__webglTexture,i.TEXTURE0+g)}function k(T,g){const I=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&I.__version!==T.version){j(I,T,g);return}else T.isExternalTexture&&(I.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,I.__webglTexture,i.TEXTURE0+g)}function z(T,g){const I=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&I.__version!==T.version){j(I,T,g);return}t.bindTexture(i.TEXTURE_3D,I.__webglTexture,i.TEXTURE0+g)}function $(T,g){const I=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&I.__version!==T.version){J(I,T,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,I.__webglTexture,i.TEXTURE0+g)}const ce={[oa]:i.REPEAT,[yn]:i.CLAMP_TO_EDGE,[la]:i.MIRRORED_REPEAT},ie={[St]:i.NEAREST,[Su]:i.NEAREST_MIPMAP_NEAREST,[ls]:i.NEAREST_MIPMAP_LINEAR,[At]:i.LINEAR,[hr]:i.LINEAR_MIPMAP_NEAREST,[jn]:i.LINEAR_MIPMAP_LINEAR},de={[bu]:i.NEVER,[Ru]:i.ALWAYS,[Tu]:i.LESS,[to]:i.LEQUAL,[Au]:i.EQUAL,[no]:i.GEQUAL,[wu]:i.GREATER,[Cu]:i.NOTEQUAL};function ze(T,g){if(g.type===ln&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===At||g.magFilter===hr||g.magFilter===ls||g.magFilter===jn||g.minFilter===At||g.minFilter===hr||g.minFilter===ls||g.minFilter===jn)&&Re("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,ce[g.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,ce[g.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,ce[g.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,ie[g.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,ie[g.minFilter]),g.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,de[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===St||g.minFilter!==ls&&g.minFilter!==jn||g.type===ln&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Ne(T,g){let I=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",w));const q=g.source;let Z=f.get(q);Z===void 0&&(Z={},f.set(q,Z));const H=W(g);if(H!==T.__cacheKey){Z[H]===void 0&&(Z[H]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,I=!0),Z[H].usedTimes++;const ye=Z[T.__cacheKey];ye!==void 0&&(Z[T.__cacheKey].usedTimes--,ye.usedTimes===0&&v(g)),T.__cacheKey=H,T.__webglTexture=Z[H].texture}return I}function ct(T,g,I){return Math.floor(Math.floor(T/I)/g)}function at(T,g,I,q){const H=T.updateRanges;if(H.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,I,q,g.data);else{H.sort((ee,ae)=>ee.start-ae.start);let ye=0;for(let ee=1;ee<H.length;ee++){const ae=H[ye],_e=H[ee],Se=ae.start+ae.count,re=ct(_e.start,g.width,4),Oe=ct(ae.start,g.width,4);_e.start<=Se+1&&re===Oe&&ct(_e.start+_e.count-1,g.width,4)===re?ae.count=Math.max(ae.count,_e.start+_e.count-ae.start):(++ye,H[ye]=_e)}H.length=ye+1;const se=i.getParameter(i.UNPACK_ROW_LENGTH),ve=i.getParameter(i.UNPACK_SKIP_PIXELS),Ce=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let ee=0,ae=H.length;ee<ae;ee++){const _e=H[ee],Se=Math.floor(_e.start/4),re=Math.ceil(_e.count/4),Oe=Se%g.width,L=Math.floor(Se/g.width),he=re,te=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Oe),i.pixelStorei(i.UNPACK_SKIP_ROWS,L),t.texSubImage2D(i.TEXTURE_2D,0,Oe,L,he,te,I,q,g.data)}T.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,se),i.pixelStorei(i.UNPACK_SKIP_PIXELS,ve),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ce)}}function j(T,g,I){let q=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(q=i.TEXTURE_3D);const Z=Ne(T,g),H=g.source;t.bindTexture(q,T.__webglTexture,i.TEXTURE0+I);const ye=n.get(H);if(H.version!==ye.__version||Z===!0){t.activeTexture(i.TEXTURE0+I);const se=ke.getPrimaries(ke.workingColorSpace),ve=g.colorSpace===Nn?null:ke.getPrimaries(g.colorSpace),Ce=g.colorSpace===Nn||se===ve?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ce);let ee=x(g.image,!1,s.maxTextureSize);ee=nt(g,ee);const ae=r.convert(g.format,g.colorSpace),_e=r.convert(g.type);let Se=S(g.internalFormat,ae,_e,g.colorSpace,g.isVideoTexture);ze(q,g);let re;const Oe=g.mipmaps,L=g.isVideoTexture!==!0,he=ye.__version===void 0||Z===!0,te=H.dataReady,fe=A(g,ee);if(g.isDepthTexture)Se=E(g.format===Kn,g.type),he&&(L?t.texStorage2D(i.TEXTURE_2D,1,Se,ee.width,ee.height):t.texImage2D(i.TEXTURE_2D,0,Se,ee.width,ee.height,0,ae,_e,null));else if(g.isDataTexture)if(Oe.length>0){L&&he&&t.texStorage2D(i.TEXTURE_2D,fe,Se,Oe[0].width,Oe[0].height);for(let Q=0,K=Oe.length;Q<K;Q++)re=Oe[Q],L?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,re.width,re.height,ae,_e,re.data):t.texImage2D(i.TEXTURE_2D,Q,Se,re.width,re.height,0,ae,_e,re.data);g.generateMipmaps=!1}else L?(he&&t.texStorage2D(i.TEXTURE_2D,fe,Se,ee.width,ee.height),te&&at(g,ee,ae,_e)):t.texImage2D(i.TEXTURE_2D,0,Se,ee.width,ee.height,0,ae,_e,ee.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){L&&he&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Se,Oe[0].width,Oe[0].height,ee.depth);for(let Q=0,K=Oe.length;Q<K;Q++)if(re=Oe[Q],g.format!==Qt)if(ae!==null)if(L){if(te)if(g.layerUpdates.size>0){const ne=tl(re.width,re.height,g.format,g.type);for(const Pe of g.layerUpdates){const it=re.data.subarray(Pe*ne/re.data.BYTES_PER_ELEMENT,(Pe+1)*ne/re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,Pe,re.width,re.height,1,ae,it)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,re.width,re.height,ee.depth,ae,re.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,Se,re.width,re.height,ee.depth,0,re.data,0,0);else Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?te&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,re.width,re.height,ee.depth,ae,_e,re.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Q,Se,re.width,re.height,ee.depth,0,ae,_e,re.data)}else{L&&he&&t.texStorage2D(i.TEXTURE_2D,fe,Se,Oe[0].width,Oe[0].height);for(let Q=0,K=Oe.length;Q<K;Q++)re=Oe[Q],g.format!==Qt?ae!==null?L?te&&t.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,re.width,re.height,ae,re.data):t.compressedTexImage2D(i.TEXTURE_2D,Q,Se,re.width,re.height,0,re.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,re.width,re.height,ae,_e,re.data):t.texImage2D(i.TEXTURE_2D,Q,Se,re.width,re.height,0,ae,_e,re.data)}else if(g.isDataArrayTexture)if(L){if(he&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Se,ee.width,ee.height,ee.depth),te)if(g.layerUpdates.size>0){const Q=tl(ee.width,ee.height,g.format,g.type);for(const K of g.layerUpdates){const ne=ee.data.subarray(K*Q/ee.data.BYTES_PER_ELEMENT,(K+1)*Q/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,ee.width,ee.height,1,ae,_e,ne)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,ae,_e,ee.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Se,ee.width,ee.height,ee.depth,0,ae,_e,ee.data);else if(g.isData3DTexture)L?(he&&t.texStorage3D(i.TEXTURE_3D,fe,Se,ee.width,ee.height,ee.depth),te&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,ae,_e,ee.data)):t.texImage3D(i.TEXTURE_3D,0,Se,ee.width,ee.height,ee.depth,0,ae,_e,ee.data);else if(g.isFramebufferTexture){if(he)if(L)t.texStorage2D(i.TEXTURE_2D,fe,Se,ee.width,ee.height);else{let Q=ee.width,K=ee.height;for(let ne=0;ne<fe;ne++)t.texImage2D(i.TEXTURE_2D,ne,Se,Q,K,0,ae,_e,null),Q>>=1,K>>=1}}else if(Oe.length>0){if(L&&he){const Q=Me(Oe[0]);t.texStorage2D(i.TEXTURE_2D,fe,Se,Q.width,Q.height)}for(let Q=0,K=Oe.length;Q<K;Q++)re=Oe[Q],L?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ae,_e,re):t.texImage2D(i.TEXTURE_2D,Q,Se,ae,_e,re);g.generateMipmaps=!1}else if(L){if(he){const Q=Me(ee);t.texStorage2D(i.TEXTURE_2D,fe,Se,Q.width,Q.height)}te&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ae,_e,ee)}else t.texImage2D(i.TEXTURE_2D,0,Se,ae,_e,ee);m(g)&&d(q),ye.__version=H.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function J(T,g,I){if(g.image.length!==6)return;const q=Ne(T,g),Z=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+I);const H=n.get(Z);if(Z.version!==H.__version||q===!0){t.activeTexture(i.TEXTURE0+I);const ye=ke.getPrimaries(ke.workingColorSpace),se=g.colorSpace===Nn?null:ke.getPrimaries(g.colorSpace),ve=g.colorSpace===Nn||ye===se?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);const Ce=g.isCompressedTexture||g.image[0].isCompressedTexture,ee=g.image[0]&&g.image[0].isDataTexture,ae=[];for(let K=0;K<6;K++)!Ce&&!ee?ae[K]=x(g.image[K],!0,s.maxCubemapSize):ae[K]=ee?g.image[K].image:g.image[K],ae[K]=nt(g,ae[K]);const _e=ae[0],Se=r.convert(g.format,g.colorSpace),re=r.convert(g.type),Oe=S(g.internalFormat,Se,re,g.colorSpace),L=g.isVideoTexture!==!0,he=H.__version===void 0||q===!0,te=Z.dataReady;let fe=A(g,_e);ze(i.TEXTURE_CUBE_MAP,g);let Q;if(Ce){L&&he&&t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Oe,_e.width,_e.height);for(let K=0;K<6;K++){Q=ae[K].mipmaps;for(let ne=0;ne<Q.length;ne++){const Pe=Q[ne];g.format!==Qt?Se!==null?L?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ne,0,0,Pe.width,Pe.height,Se,Pe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ne,Oe,Pe.width,Pe.height,0,Pe.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ne,0,0,Pe.width,Pe.height,Se,re,Pe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ne,Oe,Pe.width,Pe.height,0,Se,re,Pe.data)}}}else{if(Q=g.mipmaps,L&&he){Q.length>0&&fe++;const K=Me(ae[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Oe,K.width,K.height)}for(let K=0;K<6;K++)if(ee){L?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ae[K].width,ae[K].height,Se,re,ae[K].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Oe,ae[K].width,ae[K].height,0,Se,re,ae[K].data);for(let ne=0;ne<Q.length;ne++){const it=Q[ne].image[K].image;L?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ne+1,0,0,it.width,it.height,Se,re,it.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ne+1,Oe,it.width,it.height,0,Se,re,it.data)}}else{L?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Se,re,ae[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Oe,Se,re,ae[K]);for(let ne=0;ne<Q.length;ne++){const Pe=Q[ne];L?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ne+1,0,0,Se,re,Pe.image[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ne+1,Oe,Se,re,Pe.image[K])}}}m(g)&&d(i.TEXTURE_CUBE_MAP),H.__version=Z.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function me(T,g,I,q,Z,H){const ye=r.convert(I.format,I.colorSpace),se=r.convert(I.type),ve=S(I.internalFormat,ye,se,I.colorSpace),Ce=n.get(g),ee=n.get(I);if(ee.__renderTarget=g,!Ce.__hasExternalTextures){const ae=Math.max(1,g.width>>H),_e=Math.max(1,g.height>>H);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,H,ve,ae,_e,g.depth,0,ye,se,null):t.texImage2D(Z,H,ve,ae,_e,0,ye,se,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),pt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,Z,ee.__webglTexture,0,R(g)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,Z,ee.__webglTexture,H),t.bindFramebuffer(i.FRAMEBUFFER,null)}function De(T,g,I){if(i.bindRenderbuffer(i.RENDERBUFFER,T),g.depthBuffer){const q=g.depthTexture,Z=q&&q.isDepthTexture?q.type:null,H=E(g.stencilBuffer,Z),ye=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;pt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(g),H,g.width,g.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(g),H,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,H,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ye,i.RENDERBUFFER,T)}else{const q=g.textures;for(let Z=0;Z<q.length;Z++){const H=q[Z],ye=r.convert(H.format,H.colorSpace),se=r.convert(H.type),ve=S(H.internalFormat,ye,se,H.colorSpace);pt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(g),ve,g.width,g.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(g),ve,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ve,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function xe(T,g,I){const q=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(g.depthTexture);if(Z.__renderTarget=g,(!Z.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),q){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,g.depthTexture.addEventListener("dispose",w)),Z.__webglTexture===void 0){Z.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),ze(i.TEXTURE_CUBE_MAP,g.depthTexture);const Ce=r.convert(g.depthTexture.format),ee=r.convert(g.depthTexture.type);let ae;g.depthTexture.format===An?ae=i.DEPTH_COMPONENT24:g.depthTexture.format===Kn&&(ae=i.DEPTH24_STENCIL8);for(let _e=0;_e<6;_e++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,ae,g.width,g.height,0,Ce,ee,null)}}else X(g.depthTexture,0);const H=Z.__webglTexture,ye=R(g),se=q?i.TEXTURE_CUBE_MAP_POSITIVE_X+I:i.TEXTURE_2D,ve=g.depthTexture.format===Kn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===An)pt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ve,se,H,0,ye):i.framebufferTexture2D(i.FRAMEBUFFER,ve,se,H,0);else if(g.depthTexture.format===Kn)pt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ve,se,H,0,ye):i.framebufferTexture2D(i.FRAMEBUFFER,ve,se,H,0);else throw new Error("Unknown depthTexture format")}function We(T){const g=n.get(T),I=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const q=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),q){const Z=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,q.removeEventListener("dispose",Z)};q.addEventListener("dispose",Z),g.__depthDisposeCallback=Z}g.__boundDepthTexture=q}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(I)for(let q=0;q<6;q++)xe(g.__webglFramebuffer[q],T,q);else{const q=T.texture.mipmaps;q&&q.length>0?xe(g.__webglFramebuffer[0],T,0):xe(g.__webglFramebuffer,T,0)}else if(I){g.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[q]),g.__webglDepthbuffer[q]===void 0)g.__webglDepthbuffer[q]=i.createRenderbuffer(),De(g.__webglDepthbuffer[q],T,!1);else{const Z=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,H=g.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,H),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,H)}}else{const q=T.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),De(g.__webglDepthbuffer,T,!1);else{const Z=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,H=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,H),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,H)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function vt(T,g,I){const q=n.get(T);g!==void 0&&me(q.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),I!==void 0&&We(T)}function He(T){const g=T.texture,I=n.get(T),q=n.get(g);T.addEventListener("dispose",C);const Z=T.textures,H=T.isWebGLCubeRenderTarget===!0,ye=Z.length>1;if(ye||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=g.version,a.memory.textures++),H){I.__webglFramebuffer=[];for(let se=0;se<6;se++)if(g.mipmaps&&g.mipmaps.length>0){I.__webglFramebuffer[se]=[];for(let ve=0;ve<g.mipmaps.length;ve++)I.__webglFramebuffer[se][ve]=i.createFramebuffer()}else I.__webglFramebuffer[se]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){I.__webglFramebuffer=[];for(let se=0;se<g.mipmaps.length;se++)I.__webglFramebuffer[se]=i.createFramebuffer()}else I.__webglFramebuffer=i.createFramebuffer();if(ye)for(let se=0,ve=Z.length;se<ve;se++){const Ce=n.get(Z[se]);Ce.__webglTexture===void 0&&(Ce.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&pt(T)===!1){I.__webglMultisampledFramebuffer=i.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let se=0;se<Z.length;se++){const ve=Z[se];I.__webglColorRenderbuffer[se]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,I.__webglColorRenderbuffer[se]);const Ce=r.convert(ve.format,ve.colorSpace),ee=r.convert(ve.type),ae=S(ve.internalFormat,Ce,ee,ve.colorSpace,T.isXRRenderTarget===!0),_e=R(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,_e,ae,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.RENDERBUFFER,I.__webglColorRenderbuffer[se])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(I.__webglDepthRenderbuffer=i.createRenderbuffer(),De(I.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(H){t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),ze(i.TEXTURE_CUBE_MAP,g);for(let se=0;se<6;se++)if(g.mipmaps&&g.mipmaps.length>0)for(let ve=0;ve<g.mipmaps.length;ve++)me(I.__webglFramebuffer[se][ve],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+se,ve);else me(I.__webglFramebuffer[se],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0);m(g)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ye){for(let se=0,ve=Z.length;se<ve;se++){const Ce=Z[se],ee=n.get(Ce);let ae=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ae=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,ee.__webglTexture),ze(ae,Ce),me(I.__webglFramebuffer,T,Ce,i.COLOR_ATTACHMENT0+se,ae,0),m(Ce)&&d(ae)}t.unbindTexture()}else{let se=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(se=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(se,q.__webglTexture),ze(se,g),g.mipmaps&&g.mipmaps.length>0)for(let ve=0;ve<g.mipmaps.length;ve++)me(I.__webglFramebuffer[ve],T,g,i.COLOR_ATTACHMENT0,se,ve);else me(I.__webglFramebuffer,T,g,i.COLOR_ATTACHMENT0,se,0);m(g)&&d(se),t.unbindTexture()}T.depthBuffer&&We(T)}function je(T){const g=T.textures;for(let I=0,q=g.length;I<q;I++){const Z=g[I];if(m(Z)){const H=b(T),ye=n.get(Z).__webglTexture;t.bindTexture(H,ye),d(H),t.unbindTexture()}}}const et=[],Fe=[];function ft(T){if(T.samples>0){if(pt(T)===!1){const g=T.textures,I=T.width,q=T.height;let Z=i.COLOR_BUFFER_BIT;const H=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ye=n.get(T),se=g.length>1;if(se)for(let Ce=0;Ce<g.length;Ce++)t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer);const ve=T.texture.mipmaps;ve&&ve.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ye.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let Ce=0;Ce<g.length;Ce++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),se){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ye.__webglColorRenderbuffer[Ce]);const ee=n.get(g[Ce]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ee,0)}i.blitFramebuffer(0,0,I,q,0,0,I,q,Z,i.NEAREST),l===!0&&(et.length=0,Fe.length=0,et.push(i.COLOR_ATTACHMENT0+Ce),T.depthBuffer&&T.resolveDepthBuffer===!1&&(et.push(H),Fe.push(H),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Fe)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,et))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),se)for(let Ce=0;Ce<g.length;Ce++){t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.RENDERBUFFER,ye.__webglColorRenderbuffer[Ce]);const ee=n.get(g[Ce]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.TEXTURE_2D,ee,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function R(T){return Math.min(s.maxSamples,T.samples)}function pt(T){const g=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Ye(T){const g=a.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function nt(T,g){const I=T.colorSpace,q=T.format,Z=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||I!==Li&&I!==Nn&&(ke.getTransfer(I)===$e?(q!==Qt||Z!==Wt)&&Re("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):qe("WebGLTextures: Unsupported texture color space:",I)),g}function Me(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=G,this.setTexture2D=X,this.setTexture2DArray=k,this.setTexture3D=z,this.setTextureCube=$,this.rebindTextures=vt,this.setupRenderTarget=He,this.updateRenderTargetMipmap=je,this.updateMultisampleRenderTarget=ft,this.setupDepthRenderbuffer=We,this.setupFrameBufferTexture=me,this.useMultisampledRTT=pt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function lg(i,e){function t(n,s=Nn){let r;const a=ke.getTransfer(s);if(n===Wt)return i.UNSIGNED_BYTE;if(n===Za)return i.UNSIGNED_SHORT_4_4_4_4;if(n===$a)return i.UNSIGNED_SHORT_5_5_5_1;if(n===mc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===gc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===fc)return i.BYTE;if(n===pc)return i.SHORT;if(n===Zi)return i.UNSIGNED_SHORT;if(n===Ka)return i.INT;if(n===dn)return i.UNSIGNED_INT;if(n===ln)return i.FLOAT;if(n===Tn)return i.HALF_FLOAT;if(n===_c)return i.ALPHA;if(n===xc)return i.RGB;if(n===Qt)return i.RGBA;if(n===An)return i.DEPTH_COMPONENT;if(n===Kn)return i.DEPTH_STENCIL;if(n===vc)return i.RED;if(n===Ja)return i.RED_INTEGER;if(n===Pi)return i.RG;if(n===Qa)return i.RG_INTEGER;if(n===eo)return i.RGBA_INTEGER;if(n===Vs||n===Gs||n===Hs||n===ks)if(a===$e)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Vs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ks)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Vs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Gs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Hs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ks)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ca||n===ua||n===ha||n===da)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ca)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ua)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ha)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===da)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===fa||n===pa||n===ma||n===ga||n===_a||n===xa||n===va)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===fa||n===pa)return a===$e?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ma)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===ga)return r.COMPRESSED_R11_EAC;if(n===_a)return r.COMPRESSED_SIGNED_R11_EAC;if(n===xa)return r.COMPRESSED_RG11_EAC;if(n===va)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ma||n===Sa||n===ya||n===Ea||n===ba||n===Ta||n===Aa||n===wa||n===Ca||n===Ra||n===Pa||n===La||n===Da||n===Ia)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ma)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Sa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ya)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ea)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ba)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ta)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Aa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===wa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ca)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ra)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Pa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===La)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Da)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ia)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ua||n===Na||n===Fa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ua)return a===$e?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Na)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Fa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Oa||n===Ba||n===za||n===Va)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Oa)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ba)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===za)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Va)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===$i?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const cg=`
void main() {
...
`),e=e.replace(/\\n/g,`
`),e=e.replace(/\*\*(.*?)\*\*/g,'<strong style="color:#aee6f0;">$1</strong>'),e=e.replace(/^#\s+(.*)$/gm,""),e=e.replace(/^##\s+(.*)$/gm,'<h4 style="color:#00f3ff; margin-top:15px; margin-bottom:5px; text-transform:uppercase;">$1</h4>'),e=e.replace(/^###\s+(.*)$/gm,'<h5 style="color:#fff; margin-top:10px; margin-bottom:5px; border-bottom:1px solid rgba(255,255,255,0.1); padding-bottom:2px;">$1</h5>'),e=e.replace(/\n/gm,"<br>"),e=e.replace(/<\/h4><br>/g,"</h4>"),e=e.replace(/<\/h5><br>/g,"</h5>"),e=e.replace(/^(<br>)*/,""),e=e.replace(/(<br>)*$/,""),e}function Vg(){const i=document.getElementById("btn-spin"),e=document.getElementById("btn-reset"),t=document.getElementById("btn-toggle-info"),n=document.getElementById("btn-pan");n&&n.addEventListener("click",()=>{const S=Y.toggleAutoPan();n.classList.toggle("active",S)});const s=document.getElementById("palette-trigger"),r=document.getElementById("palette-menu"),a=document.querySelectorAll(".palette-option");s&&r&&(s.addEventListener("click",E=>{E.stopPropagation(),r.classList.toggle("hidden")}),document.querySelectorAll(".legend-label").forEach(E=>{E.addEventListener("click",A=>{A.stopPropagation(),s.click()})}),document.addEventListener("click",()=>{r.classList.add("hidden")}),a.forEach(E=>{E.addEventListener("click",A=>{A.stopPropagation();const w=E.dataset.palette;Xr=w,Y&&Y.setPalette(w),Ee&&Ee.setPalette(w),s.className=`gradient-bar ${w}`,r.classList.add("hidden")})}),s.className=`gradient-bar ${Xr}`),i&&i.addEventListener("click",()=>{const S=i.classList.toggle("active");Y.setAutoRotate(S),Ee.setAutoRotate(S),i.textContent=S?"AUTO-ROTATE: ON":"AUTO-ROTATE: OFF"}),e&&e.addEventListener("click",()=>{Y.resetView(),Ee.resetView()}),t&&(document.getElementById("btn-toggle-info").addEventListener("click",()=>{const S=document.querySelectorAll(".artifact-details");Us=!Us,S.forEach(E=>E.style.opacity=Us?"1":"0"),document.getElementById("btn-toggle-info").textContent=Us?"HIDE INFO":"SHOW INFO",setTimeout(()=>{Y&&Y.onResize(),Ee&&Ee.onResize()},300)}),window.innerWidth<900&&(document.querySelector(".ui-layer").classList.add("no-details"),t.textContent="SHOW INFO"));const o=document.getElementById("btn-about"),l=document.getElementById("about-modal"),c=document.getElementById("btn-close-about");o&&l&&(o.addEventListener("click",()=>l.classList.remove("hidden")),c&&c.addEventListener("click",()=>l.classList.add("hidden")),l.addEventListener("click",S=>{S.target===l&&l.classList.add("hidden")}));const u=document.getElementById("rot-speed");u&&u.addEventListener("input",S=>{const E=parseFloat(S.target.value);Y&&Y.setRotSpeed(E),Ee&&Ee.setRotSpeed(E)});const h=document.getElementById("pan-limit-min"),f=document.getElementById("pan-limit-max"),p=document.getElementById("pan-track");function _(){if(!h||!f||!p)return;let S=parseFloat(h.value),E=parseFloat(f.value);S>E-1&&(S=E-1,h.value=S);const A=parseFloat(h.min),w=parseFloat(h.max),C=(S-A)/(w-A)*100,F=(E-A)/(w-A)*100;p.style.left=C+"%",p.style.width=F-C+"%",Y&&(Y.setPanMin(S),Y.setPanMax(E)),Ee&&(Ee.setPanMin(S),Ee.setPanMax(E))}h&&f&&(h.addEventListener("input",_),f.addEventListener("input",_),_());const x=document.getElementById("btn-movement"),m=document.getElementById("btn-perf"),d=document.getElementById("movement-controls"),b=document.getElementById("perf-controls");if(x&&m&&d&&b){x.addEventListener("click",()=>{const A=!x.classList.contains("open");x.classList.toggle("open",A),d.classList.toggle("open",A),m.classList.remove("open"),b.classList.remove("open")}),m.addEventListener("click",()=>{const A=!m.classList.contains("open");m.classList.toggle("open",A),b.classList.toggle("open",A),x.classList.remove("open"),d.classList.remove("open")});const S=document.createElement("div");S.className="control-group",S.innerHTML=`
    ...
    `,d.appendChild(S);const E=document.getElementById("initial-distance-slider");E&&E.addEventListener("input",A=>{const w=parseFloat(A.target.value);Y&&Y.setInitialDistanceMultiplier(w),Ee&&Ee.setInitialDistanceMultiplier(w),document.getElementById("initial-distance-display").textContent=w.toFixed(1),It("setting",{id:"initial-distance-slider",val:w})})}if(b){const S=document.createElement("div");S.className="control-group",S.innerHTML=`
      <label for="auto-fps-checkbox" class="control-label">Auto FPS</label>
      <input type="checkbox" id="auto-fps-checkbox" checked>
    `,b.appendChild(S);const E=document.getElementById("auto-fps-checkbox");E&&E.addEventListener("change",W=>{Ya=W.target.checked});const A=document.createElement("div");A.className="control-group",A.innerHTML=`
    ...
    `,b.appendChild(A);const w=document.getElementById("target-fps-slider");w&&w.addEventListener("input",W=>{window.targetFPS=parseInt(W.target.value),document.getElementById("target-fps-display").textContent=W.target.value});const C=document.createElement("div");C.className="control-row",C.innerHTML=`
    ...
    `,b.appendChild(C);const F=document.createElement("div");F.className="control-row",F.innerHTML=`
    ...
    `,b.appendChild(F);const v=document.createElement("button");v.className="minimal-btn",v.textContent="COPY SETTINGS",v.style.marginTop="10px",v.addEventListener("click",()=>{const W={panSpeed:parseFloat(document.getElementById("pan-speed").value),rotSpeed:parseFloat(document.getElementById("rot-speed").value),panMin:parseFloat(document.getElementById("pan-limit-min").value),panMax:parseFloat(document.getElementById("pan-limit-max").value),initialDistanceMultiplier:parseFloat(document.getElementById("initial-distance-slider").value),pointSize:parseFloat(document.getElementById("point-size-slider").value),lfoAmount:parseFloat(document.getElementById("lfo-slider").value),lfoSpeed:parseFloat(document.getElementById("lfo-speed").value),lineDist:parseFloat(document.getElementById("line-dist-slider").value),nodeDist:parseFloat(document.getElementById("node-dist-slider").value),lineDensity:parseFloat(document.getElementById("line-density-slider").value),nodeDensity:parseFloat(document.getElementById("node-density-slider").value),summarizeThin:parseFloat(document.getElementById("summarize-thin").value),viewHeight:parseFloat(document.getElementById("view-height").value),xorDensity:parseFloat(document.getElementById("xor-density-slider").value),nodeOpacity:parseFloat(document.getElementById("node-opacity-slider").value),pulse:document.getElementById("btn-toggle-pulse").classList.contains("active"),autoPan:document.getElementById("btn-pan").classList.contains("active"),autoRotate:document.getElementById("btn-spin").classList.contains("active"),targetFPS,autoFPS:Ya,palette:Xr,inverted:sn},X=JSON.stringify(W,null,2);navigator.clipboard.writeText(X).then(()=>{Dt("Settings copied to clipboard!")}).catch(k=>{console.error("Failed to copy settings:",k),Dt("Failed to copy settings.",!0)})}),b.appendChild(v);const y=document.getElementById("font-select"),P=document.getElementById("replace-orbitron"),G=document.getElementById("keep-h1-orbitron"),O=document.querySelector(".logo-text h1");if(y&&P&&G&&O){const W=()=>{const X=y.value,k=P.checked,z=G.checked,$=document.documentElement.style,ce={rajdhani:"Rajdhani, sans-serif",inter:"Inter, sans-serif",arimo:"Arimo, sans-serif",ibm:"IBM Plex Sans, sans-serif"};$.setProperty("--font-body",ce[X]||"Inter, sans-serif"),$.setProperty("--font-mono",ce[X]||"Inter, sans-serif");const ie=k&&ce[X]||"Orbitron, sans-serif";$.setProperty("--font-header",ie),z?O.style.fontFamily="Orbitron, sans-serif":O.style.fontFamily=ie};y.addEventListener("change",W),P.addEventListener("change",W),G.addEventListener("change",W)}}}const rt=document.getElementById("btn-record"),Bn=document.getElementById("btn-save-attract"),Nl=document.getElementById("btn-load-attract");rt&&rt.addEventListener("click",()=>{if(Ai){if(Ai=!1,clearInterval(Ul),rt.textContent="RECORD ATTRACT",rt.classList.remove("active"),Y&&(Y.enableCrossFade=!0),Ee&&(Ee.enableCrossFade=!0),Xt.length>0){rt&&rt.classList.remove("hidden"),Bn&&Bn.classList.remove("hidden");const i=JSON.stringify(Xt);navigator.clipboard.writeText(i).then(()=>{Dt("Session data copied to clipboard!")}).catch(e=>{console.error("Failed to copy path:",e),Dt("Failed to copy session.",!0)})}}else{if(ii)qc();else if(Xt.length>0){Xc();return}Ai=!0,Xt=[],Hc=Date.now(),rt.textContent="STOP RECORDING",rt.classList.add("active"),Dt("Recording session (clicks, camera, settings)..."),Y&&(Y.enableCrossFade=!1),Ee&&(Ee.enableCrossFade=!1),ts&&It("model-load",{url:ts,slot:"main"}),Ul=setInterval(()=>{Y&&Y.camera&&Y.controls&&It("camera",{pos:{x:parseFloat(Y.camera.position.x.toFixed(3)),y:parseFloat(Y.camera.position.y.toFixed(3)),z:parseFloat(Y.camera.position.z.toFixed(3))},target:{x:parseFloat(Y.controls.target.x.toFixed(3)),y:parseFloat(Y.controls.target.y.toFixed(3)),z:parseFloat(Y.controls.target.z.toFixed(3))}})},100)}});Bn&&Bn.addEventListener("click",()=>{if(Xt.length===0)return;const i=new Blob([JSON.stringify(Xt)],{type:"application/json"}),e=URL.createObjectURL(i),t=document.createElement("a");t.href=e,t.download=`prismata_attract_${Date.now()}.json`,t.click(),URL.revokeObjectURL(e),Dt("Attract mode file downloaded.")});Nl&&Nl.addEventListener("click",()=>{const i=prompt("PASTE ATTRACT JSON HERE:");if(i)try{const e=JSON.parse(i);Array.isArray(e)?(Xt=e,rt&&rt.classList.remove("hidden"),Bn&&Bn.classList.remove("hidden"),Dt("Attract sequence loaded!")):Dt("Invalid data format.",!0)}catch{Dt("Failed to parse JSON.",!0)}});function Xc(){console.log("Starting attract playback session..."),ii=!0,Ni=!1,uo=0,rt&&(rt.textContent="STOP ATTRACT",rt.classList.add("active"),rt.classList.remove("hidden")),Tt&&Tt.classList.add("hidden"),Dt("Demo mode - interact to pause"),tr(0)}function qc(){ii=!1,Ni=!1,ns&&clearTimeout(ns),rt&&(rt.textContent="RECORD ATTRACT",rt.classList.remove("active"),rt.classList.remove("hidden")),Tt&&Tt.classList.add("hidden"),Y&&Y.controls&&(Y.controls.enabled=!0,Y.controls.enableRotate=!0,Y.controls.enableZoom=!0,Y.controls.enablePan=!0),Dt("Playback stopped.")}function Gg(){console.log("Pausing playback"),ii&&(Ni=!0,ns&&clearTimeout(ns),rt&&(rt.textContent="RECORD NEW",rt.classList.remove("hidden")),Tt?(console.log("Removing hidden from btnResume"),Tt.classList.remove("hidden"),Tt.style.fontWeight="bold",Tt.classList.add("pulse-appear"),Tt.addEventListener("animationend",()=>{Tt.classList.remove("pulse-appear")},{once:!0})):console.log("btnResume is null"),Y&&Y.controls&&(Y.controls.enabled=!0,Y.controls.enableRotate=!0,Y.controls.enableZoom=!0,Y.controls.enablePan=!0))}function Hg(){if(ii){if(Ni=!1,Tt&&Tt.classList.add("hidden"),rt&&(rt.classList.remove("hidden"),rt.textContent="STOP ATTRACT"),Dt("Resuming playback..."),ts){const i=Array.from(document.querySelectorAll(".crystal-item")).find(e=>e.dataset.url===ts);i&&i.click()}tr(uo)}}function tr(i){if(uo=i,!ii||Ni)return;if(i>=Xt.length){if(!Xt.some(o=>o.type==="model-load")){qc();return}Dt("Looping playback...");const a=Array.from(qs.querySelectorAll(".crystal-item")).find(o=>o.dataset.name.includes("The Twin Spires")||o.dataset.modelName.includes("CLIP"));a&&a.click(),tr(0);return}const e=Xt[i],t=Xt[i+1],n=t?t.time-e.time:0;kg(e,n),ns=setTimeout(()=>{tr(i+1)},n)}function kg(i,e=0){switch(i.type){case"camera":if(Y&&Y.camera&&Y.controls)if(e>0){let r=function(){h++;const f=h/u;Y.camera.position.lerpVectors(a,l,f),Y.controls.target.lerpVectors(o,c,f),Y.controls.update(),h<u&&setTimeout(r,16)};const a=Y.camera.position.clone(),o=Y.controls.target.clone(),l=new D(i.value.pos.x,i.value.pos.y,i.value.pos.z),c=new D(i.value.target.x,i.value.target.y,i.value.target.z),u=Math.max(1,Math.floor(e/16));let h=0;r()}else Y.camera.position.set(i.value.pos.x,i.value.pos.y,i.value.pos.z),Y.controls.target.set(i.value.target.x,i.value.target.y,i.value.target.z),Y.controls.update();break;case"model-load":const t=Array.from(document.querySelectorAll(".crystal-item")).find(r=>r.dataset.url===i.value.url);t&&(document.querySelectorAll(".crystal-item").forEach(r=>r.classList.remove("active")),t.classList.add("active"),Wc(t.dataset,i.value.slot),t.scrollIntoView({behavior:"smooth",block:"center"}),t.classList.add("model-flash"),setTimeout(()=>t.classList.remove("model-flash"),6e3));break;case"setting":const n=document.getElementById(i.value.id);n&&(n.value=i.value.val,n.dispatchEvent(new Event("input")));break;case"btn-click":const s=document.getElementById(i.value.id);s&&(i.value.id==="btn-toggle-pulse"?s.classList.contains("active")!==i.value.active&&s.click():i.value.id==="btn-node-blend"||i.value.id==="btn-line-blend"?s.textContent.toLowerCase()!==i.value.mode&&s.click():s.click());break}}const qr=document.getElementById("btn-easter-egg");qr&&qr.addEventListener("click",()=>{if(Y){const i=Y.toggleEasterEgg();qr.classList.toggle("active",i),i?Dt("Lightcycle Arena: ONLINE"):Dt("Lightcycle Arena: OFFLINE",!0)}});const Ns=document.getElementById("btn-toggle-pulse");Ns&&Ns.addEventListener("click",()=>{const i=Ns.classList.toggle("active");Ns.textContent=i?"FLOW: ON":"FLOW: OFF",Y&&Y.setPulse(i),It("btn-click",{id:"btn-toggle-pulse",active:i})});const Fl=document.getElementById("point-size-slider");Fl&&Fl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setBaseSize(e),Ee&&Ee.setBaseSize(e),It("setting",{id:"point-size-slider",val:e})});const Ol=document.getElementById("view-height");Ol&&Ol.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setManualHeight(e),Ee&&Ee.setManualHeight(e),It("setting",{id:"view-height",val:e})});const Bl=document.getElementById("lfo-slider");Bl&&Bl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setLFOAmount(e),Ee&&Ee.setLFOAmount(e),It("setting",{id:"lfo-slider",val:e})});const zl=document.getElementById("lfo-speed");zl&&zl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setLFOSpeed(e),Ee&&Ee.setLFOSpeed(e),It("setting",{id:"lfo-speed",val:e})});const Vl=document.getElementById("line-dist-slider");Vl&&Vl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setLineDist(e),Ee&&Ee.setLineDist(e),It("setting",{id:"line-dist-slider",val:e})});const Gl=document.getElementById("node-dist-slider");Gl&&Gl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setNodeDist(e),Ee&&Ee.setNodeDist(e),It("setting",{id:"node-dist-slider",val:e})});const Hl=document.getElementById("line-density-slider");Hl&&Hl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setLineDensity(e),Ee&&Ee.setLineDensity(e),It("setting",{id:"line-density-slider",val:e})});const kl=document.getElementById("node-density-slider");kl&&kl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setNodeDensity(e),Ee&&Ee.setNodeDensity(e),It("setting",{id:"node-density-slider",val:e})});const Wl=document.getElementById("summarize-thin");Wl&&Wl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setThinning(e),Ee&&Ee.setThinning(e)});const Xl=document.getElementById("xor-density-slider");Xl&&Xl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setXorDensity(e),Ee&&Ee.setXorDensity(e)});const ql=document.getElementById("color-infl-slider");ql&&ql.addEventListener("input",i=>{const e=parseFloat(i.target.value)/100;Y&&Y.setColorInfluence(e),Ee&&Ee.setColorInfluence(e)});const Yl=document.getElementById("line-opacity-slider");Yl&&Yl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setLineOpacity(e),Ee&&Ee.setLineOpacity(e)});const jl=document.getElementById("node-satur-slider");jl&&jl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setNodeSaturation(e),Ee&&Ee.setNodeSaturation(e)});const Kl=document.getElementById("node-opacity-slider");Kl&&Kl.addEventListener("input",i=>{const e=parseFloat(i.target.value);Y&&Y.setNodeOpacity(e),Ee&&Ee.setNodeOpacity(e)});const Fs=document.getElementById("btn-node-blend");Fs&&Fs.addEventListener("click",()=>{const i=Fs.textContent==="NORMAL";Fs.textContent=i?"ADDITIVE":"NORMAL";const e=i?"additive":"normal";Y&&Y.setNodeBlending(e),Ee&&Ee.setNodeBlending(e),It("btn-click",{id:"btn-node-blend",mode:e})});const Os=document.getElementById("btn-line-blend");Os&&Os.addEventListener("click",()=>{const i=Os.textContent==="NORMAL";Os.textContent=i?"ADDITIVE":"NORMAL";const e=i?"additive":"normal";Y&&Y.setLineBlending(e),Ee&&Ee.setLineBlending(e),It("btn-click",{id:"btn-line-blend",mode:e})});const Bs=document.getElementById("btn-invert-influence");Bs&&(Bs.textContent=sn?"INVERTED (COMPLEMENTARY)":"DIRECT INFLUENCE",Y&&Y.setInvertInfluence(sn),Ee&&Ee.setInvertInfluence(sn),Bs.addEventListener("click",()=>{sn=!sn,Bs.textContent=sn?"INVERTED (COMPLEMENTARY)":"DIRECT INFLUENCE",Y&&Y.setInvertInfluence(sn),Ee&&Ee.setInvertInfluence(sn),Gc()}));const Zl=document.getElementById("file-upload");Zl&&Zl.addEventListener("change",i=>{const e=i.target.files[0];if(!e)return;const t=URL.createObjectURL(e);console.log("Loading custom file:",t),wi("main"),Y.loadCrystal(t).then(n=>{Sn.main.superTitle&&(Sn.main.superTitle.textContent="CUSTOM UPLOAD"),Sn.main.title.textContent=e.name.toUpperCase().replace(".PLY",""),Sn.main.type.textContent="USER DATA",Sn.main.nodes.textContent=n.nodes.toLocaleString(),Sn.main.links.textContent=n.links.toLocaleString(),Sn.main.desc.innerHTML="PREVISUALIZATION MODE<br><br>Loaded local artifact: "+e.name,modal&&modal.classList.add("hidden")}).catch(n=>{alert("Failed to load PLY: "+n)})});const $l=document.getElementById("btn-mobile-menu");$l&&$l.addEventListener("click",()=>{document.querySelector(".gallery-nav").classList.toggle("active")});Ng.addEventListener("change",i=>{es=i.target.checked,es?(Dl.classList.remove("hidden"),Ll.classList.add("split"),$n.classList.remove("hidden"),wi("compare"),setTimeout(()=>{Y.onResize(),Ee.onResize()},550)):(Dl.classList.add("hidden"),Ll.classList.remove("split"),$n.classList.add("hidden"),wi("main"),setTimeout(()=>{Y.onResize()},550))});function Dt(i,e=!1){let t=document.getElementById("toast-notification");t||(t=document.createElement("div"),t.id="toast-notification",t.className="toast-notification",document.body.appendChild(t)),t.textContent=i,t.classList.remove("alert"),e&&t.classList.add("alert"),t.offsetWidth,t.classList.add("show"),window.toastTimeout&&clearTimeout(window.toastTimeout),window.toastTimeout=setTimeout(()=>{t.classList.remove("show")},2e3)}const nr=document.getElementById("timeline-overlay"),Yr=document.getElementById("timeline-track"),vi=document.getElementById("timeline-year"),Mi=document.getElementById("timeline-title"),Si=document.getElementById("timeline-desc"),Jl=document.getElementById("btn-prev-model"),Ql=document.getElementById("btn-next-model"),ec=document.getElementById("btn-close-timeline");let Ys=[],ji=0;function Wg(i){Ys=[...i].sort((e,t)=>e.year-t.year),Yr&&(Yr.innerHTML="",Ys.forEach((e,t)=>{if(!e.crystals||e.crystals.length===0)return;e.crystals[0];const n=document.createElement("div");n.className="timeline-node",n.dataset.index=t,n.innerHTML=`
          <div class="node-dot"></div>
          <span class="node-year">${e.year}</span>
          <span class="node-label">${e.name}</span>
        `,n.addEventListener("click",()=>{js(t)}),Yr.appendChild(n)})),Jl&&Jl.addEventListener("click",()=>{ji>0&&js(ji-1)}),Ql&&Ql.addEventListener("click",()=>{ji<Ys.length-1&&js(ji+1)}),ec&&ec.addEventListener("click",()=>{qg()})}function Xg(){nr&&nr.classList.remove("hidden");const i=document.querySelector(".gallery-nav"),e=document.querySelector(".artifact-details"),t=document.querySelector(".gallery-header");if(i&&(i.style.opacity="0",i.style.pointerEvents="none"),e&&(e.style.opacity="0"),t&&(t.style.opacity="0"),typeof es<"u"&&es){const n=document.getElementById("compare-toggle");n&&(n.checked=!1,n.dispatchEvent(new Event("change")))}js(0)}function qg(){nr&&nr.classList.add("hidden");const i=document.querySelector(".gallery-nav"),e=document.querySelector(".artifact-details"),t=document.querySelector(".gallery-header");i&&(i.style.opacity="1",i.style.pointerEvents="auto"),e&&(e.style.opacity="1"),t&&(t.style.opacity="1"),Y&&Y.resetView()}function js(i){ji=i;const e=Ys[i];if(!e)return;const t=e.crystals[0];document.querySelectorAll(".timeline-node").forEach(s=>{s.classList.remove("active"),parseInt(s.dataset.index)===i&&(s.classList.add("active"),s.scrollIntoView({behavior:"smooth",inline:"center"}))}),Mi&&(Mi.style.opacity=0),Si&&(Si.style.opacity=0),vi&&(vi.style.opacity=0),setTimeout(()=>{vi&&(vi.textContent=e.year),Mi&&(Mi.textContent=e.name),Si&&(Si.textContent=e.desc),Mi&&(Mi.style.opacity=1),Si&&(Si.style.opacity=1),vi&&(vi.style.opacity=1)},200);const n={url:`./${t.file}`,name:t.name,type:e.type,modelName:e.name,desc:t.desc,modelId:e.id};Y&&Y.loadCrystal(n.url).then(()=>{}).catch(s=>console.error(s))}setTimeout(()=>{const i=document.querySelector(".status-indicator");if(i){const e=document.createElement("button");e.id="btn-timeline",e.className="minimal-btn",e.textContent="TIMELINE VIEW",e.style.border="1px solid rgba(0, 243, 255, 0.3)",e.addEventListener("click",Xg),console.log("Timeline View button created with cyan color"),e.style.display="none",i.insertBefore(e,Tt.nextSibling)}},1e3);or("./crystals/manifest.json").then(i=>{if(!i.ok)throw new Error(`Failed to load timeline manifest: ${i.status} ${i.statusText}`);return i.json()}).then(i=>{Wg(i)}).catch(i=>{console.error("Failed to setup timeline:",i)});let jr=0,Kr=0;window.addEventListener("fps-update",i=>{const e=i.detail.fps,t=document.getElementById("summarize-thin"),n=document.getElementById("line-dist-slider"),s=document.getElementById("node-dist-slider"),r=document.getElementById("line-density-slider"),a=document.getElementById("node-density-slider"),o=document.getElementById("xor-density-slider");if(!t||!n||!s||!r||!a||!o)return;let l=parseFloat(t.value),c=parseFloat(n.value),u=parseFloat(s.value),h=parseFloat(r.value),f=parseFloat(a.value),p=parseFloat(o.value),_=l,x=c,m=u,d=h,b=f,S=p;Ya&&(e<targetFPS&&e>0?(p>5?(S=Math.max(5,p-5),Kr=0):(Kr++,Kr>5&&(l<1?_=Math.min(1,l+.1):h>10||f>30?(h>10&&(d=Math.max(10,h-8)),f>30&&(b=Math.max(30,f-4))):(x=Math.max(10,c-20),m=Math.max(10,u-20)))),jr=0):e>=targetFPS+1&&(jr++,jr>4&&(f<100?b=Math.min(100,f+2):c<100?(x=Math.min(100,c+5),m=Math.min(100,u+5)):h<100?d=Math.min(100,h+1):l>.4?_=Math.max(.4,l-.05):p<100&&(S=Math.min(100,p+1)))),(_!==l||x!==c||m!==u||d!==h||b!==f||S!==p)&&(t.value=_,n.value=x,s.value=m,r.value=d,a.value=b,o.value=S,[Y,Ee].forEach(E=>{E&&(E.setThinning(_),E.setLineDist(x),E.setNodeDist(m),E.setLineDensity(d),E.setNodeDensity(b),E.setXorDensity(S))})))});
